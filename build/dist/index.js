...
(function($$, escapeHtml) {
    // 组件注册
    rpose.registerComponents({ "ui-line": UiLine, index: Index });
            ...
            c: [
                {
                    ...
                    a: { class: { _ttmypm: 1 } },
                    c: [
                        { t: "h2", a: { class: { _14hounl: 1 } }, c: [{ s: "GOTOEASY", k: 4 }], x: 1, k: 3 },
                        {
                            t: "p",
                            a: { class: { _1jrnnzg: 1 } },
                            c: [{ s: "WRITE BUSINESS, DONE ", k: 6 }, { t: "br", x: 1, k: 7 }, { s: "IT SHOULD BE SO EASY", k: 8 }],
                            x: 1,
                            k: 5
                        },
                        { t: "ui-line", a: { height: "3px", width: "50%", color: "#ff9408" }, m: 1, k: 9 },
                        { t: "span", a: { class: { _1jrnnzg: 1 } }, c: [{ s: "写业务，完成，就该这么简单", k: 11 }], x: 1, k: 10 },
                        {
                            t: "div",
                            a: { class: { _nhbga6: 1 } },
                            c: [
                                {
                                    t: "a",
                                    a: { href: "https://github.com/gotoeasy/block-text-file", style: "margin:5px;width:110px" },
                                    c: [{ s: "BTF SPEC", k: 14 }],
                                    x: 1,
                                    k: 13
                                },
                                {
                                    t: "a",
                                    a: { href: "./pages/p101-rpose-start.html", style: "margin:5px;width:110px" },
                                    c: [{ s: "RPOSE", k: 16 }],
                                    x: 1,
                                    k: 15
                                }
