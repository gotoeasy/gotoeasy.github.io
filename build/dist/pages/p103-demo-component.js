            ...
            function(require, module, exports) {
                ...
                (function($$) {
                    ...
                    rpose.registerComponents({
                        "@rpose/buildin:```": $rpose$buildin$$$$,
                        "ui-blockquote": UiBlockquote,
                        "ui-button": UiButton,
                        "ui-line": UiLine,
                        "ui-navbar": UiNavbar,
                        "ui-sidemenu": UiSidemenu,
                        "p103-demo-component": P103DemoComponent
                    }); // ------------------------------------------------------------------------------------------------------
                    // 组件 $rpose$buildin$$$$
                    ...
                    $rpose$buildin$$$$.prototype.$OPTION_KEYS = ["lang", "height", "$CODE"]; // 可通过标签配置的属性，未定义则不支持外部配置

                    $rpose$buildin$$$$.prototype.$STATE_KEYS = ["$SLOT"]; // 可更新的state属性，未定义则不支持外部更新state
                    // 组件函数

                    function $rpose$buildin$$$$() {
                        var _this2 = this;
                        ...
                        this.render = function() {
                            ...
                            if (_this2.isInitRender) {
                                rpose.extend(_this2.$state, state, _this2.$STATE_KEYS);

                                var vnode = _this2.nodeTemplate(_this2.$state, _this2.$options, _this2.$actions, _this2);

                                var el = rpose.createDom(vnode, _this2);

                                if (el && el.nodeType == 1) {
                                    $$(el).addClass(_this2.$COMPONENT_ID);
                                    $$(el.children[0]).attr("innerHTML", _this2.$options.$CODE);
                                }

                                _this2.isInitRender = false;
                                return el;
                            }
                        };
                    }
                    ...
                    $rpose$buildin$$$$.prototype.nodeTemplate = function nodeTemplate($state, $options, $actions, $this) {
                        return {
                            t: "pre",
                            r: 1,
                            k: 2,
                            c: [
                                {
                                    ...
                                    a: {
                                        class: {
                                            highlight___x8kpoq: 1
                                        }
                                    }
                                }
                            ],
                            a: {
                                style: "max-height:" + ($options.height || "500px"),
                                class: {
                                    highlight___x8kpoq: 1
                                }
                            }
                    ...
                    UiBlockquote.prototype.$OPTION_KEYS = undefined; // 可通过标签配置的属性，未定义则不支持外部配置

                    UiBlockquote.prototype.$STATE_KEYS = ["text", "$SLOT"]; // 可更新的state属性，未定义则不支持外部更新state
                    // 组件函数
                    ...
                    UiButton.prototype.$STATE_KEYS = ["value", "disabled", "$SLOT"]; // 可更新的state属性，未定义则不支持外部更新state
                    // 组件函数
                    ...
                    UiLine.prototype.$STATE_KEYS = ["$SLOT"]; // 可更新的state属性，未定义则不支持外部更新state
                    // 组件函数
                    ...
                    UiLine.prototype.nodeTemplate = function nodeTemplate($state, $options, $actions, $this) {
                        ...
                        return {
                            ...
                            c: [],
                            a: {
                                style: "background-color:" + color + ";height:" + height + ";width:" + width + ";margin:" + margin
                            }
                        };
                    }; // ------------------------------------------------------------------------------------------------------
                    // 组件 UiNavbar
                    ...
                    UiNavbar.prototype.$OPTION_KEYS = undefined; // 可通过标签配置的属性，未定义则不支持外部配置

                    UiNavbar.prototype.$STATE_KEYS = ["$SLOT"]; // 可更新的state属性，未定义则不支持外部更新state
                    // 组件函数
                            ...
                            c: [
                                {
                                    ...
                                    a: {
                                        href: "javascript:rpose.at('sidemenu.open')",
                                        class: {
                                            "nav-icon___kj5udo": 1
                                        }
                                    }
                    ...
                    UiSidemenu.prototype.$OPTION_KEYS = undefined; // 可通过标签配置的属性，未定义则不支持外部配置

                    UiSidemenu.prototype.$STATE_KEYS = ["show", "$SLOT"]; // 可更新的state属性，未定义则不支持外部更新state
                    // 组件函数
                    ...
                    function UiSidemenu() {
                        ...
                        this.$actions = {
                            close: function close(e) {
                                return rpose.at("sidemenu.close");
                            }
                        }; // 自定义方法

                        this.init = function() {
                            rpose.on("sidemenu.open", function() {
                                var el = _this3.getRefElement("menu");

                                el && (el.style.width = "250px");
                            });
                            rpose.on("sidemenu.close", function() {
                                var el = _this3.getRefElement("menu");
                    ...
                    UiSidemenu.prototype.nodeTemplate = function nodeTemplate($state, $options, $actions, $this) {
                        return {
                                            ...
                                            c: [
                                                {
                                                    ...
                                                    a: {
                                                        href: "../pages/p101-rpose-start.html"
                                                    }
                                                }
                                            ]
                                        },
                                            ...
                                            c: [
                                                {
                                                    ...
                                                    c: [
                                                        {
                                                            s: "2 第一个 hello world 组件",
                                                            k: 7
                                                        }
                                                    ],
                                                    a: {
                                                        href: "../pages/p102-demo-helloworld.html"
                                                    }
                                                }
                                            ]
                                        },
                                            ...
                                            c: [
                                                {
                                                    ...
                                                    a: {
                                                        href: "../pages/p103-demo-component.html"
                                                    }
                                                }
                                            ]
                                        },
                                            ...
                                            c: [
                                                {
                                                    ...
                                                    a: {
                                                        href: "../pages/p104-demo-setup.html"
                                                    }
                                                }
                                            ]
                                        },
                                            ...
                                            c: [
                                                {
                                                    ...
                                                    a: {
                                                        href: "../pages/p105-demo-prerender.html"
                                                    }
                                                }
                                            ]
                                        },
                                            ...
                                            c: [
                                                {
                                                    ...
                                                    a: {
                                                        href: "../pages/p106-demo-slot.html"
                                                    }
                                                }
                                            ]
                                        },
                                            ...
                                            c: [
                                                {
                                                    ...
                                                    a: {
                                                        href: "../pages/p107-demo-route.html"
                                                    }
                                                }
                                            ]
                                        }
                            ...
                            a: {
                                ...
                                $context: $this,
                                class: {
                                    "side-menu___1gr7b70": 1
                                }
                            }
                        };
                    }; // ------------------------------------------------------------------------------------------------------
                    // 组件 P103DemoComponent
                    // 注:应通过rpose.newComponentProxy方法创建组件代理对象后使用，而不是直接调用方法或用new创建
                    // ------------------------------------------------------------------------------------------------------
                    // 属性接口定义

                    P103DemoComponent.prototype.$OPTION_KEYS = undefined; // 可通过标签配置的属性，未定义则不支持外部配置

                    P103DemoComponent.prototype.$STATE_KEYS = ["$SLOT"]; // 可更新的state属性，未定义则不支持外部更新state
                    // 组件函数

                    function P103DemoComponent() {
                        var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
                        // 组件默认选项值
                        this.$options = {}; // 组件默认数据状态值
                    ...
                    P103DemoComponent.prototype.nodeTemplate = function nodeTemplate($state, $options, $actions, $this) {
                        return {
                            t: "div",
                            r: 1,
                            k: 88,
                                    ...
                                    c: [
                                        {
                                            ...
                                            c: [],
                                            a: {
                                                text: "3.1 内置组件 —— 代码块语法高亮组件"
                                            }
                                        },
                                        {
                                            s: "\r\n免不了要展示代码，吸收md格式写法的便利性，再加上highlight.js的API，rpose就这样内置了一个组件",
                                            k: 4
                                        },
                                        {
                                            t: "br",
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                lang: "rpose",
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq comment___x8kpoq">// 代码块语法高亮，例子1</span></li><li><span class="token___x8kpoq selector___x8kpoq">[view]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li>```</li><li>var hello = name => \'Hello \' + name + \'!\';</li><li>```</li></ol>'
                                            }
                                        },
                                        {
                                            s: "效果：\r\n",
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                $CODE:
                                                    '<ol><li>var hello <span class="token___x8kpoq operator___x8kpoq">=</span> name <span class="token___x8kpoq operator___x8kpoq">=</span><span class="token___x8kpoq operator___x8kpoq">></span> <span class="token___x8kpoq string___x8kpoq">\'Hello \'</span> <span class="token___x8kpoq operator___x8kpoq">+</span> name <span class="token___x8kpoq operator___x8kpoq">+</span> <span class="token___x8kpoq string___x8kpoq">\'!\'</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li></ol>'
                                            }
                                        },
                                        {
                                            t: "br",
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq comment___x8kpoq">// 例子2，加上语言，和md一样</span></li><li>```js</li><li>var hello <span class="token___x8kpoq operator___x8kpoq">=</span> name <span class="token___x8kpoq operator___x8kpoq">=</span><span class="token___x8kpoq operator___x8kpoq">></span> <span class="token___x8kpoq string___x8kpoq">\'Hello \'</span> <span class="token___x8kpoq operator___x8kpoq">+</span> name <span class="token___x8kpoq operator___x8kpoq">+</span> <span class="token___x8kpoq string___x8kpoq">\'!\'</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>```</li><li></li><li></li><li></li><li><span class="token___x8kpoq comment___x8kpoq">// 例子3，代码很多行的时候，得限制最大高度</span></li><li>```js max<span class="token___x8kpoq operator___x8kpoq">-</span>height<span class="token___x8kpoq operator___x8kpoq">=</span><span class="token___x8kpoq number___x8kpoq">50</span>px  <span class="token___x8kpoq comment___x8kpoq">// 事实上写法比较随意，比如其实这样写也是一样的 ```js 50px</span></li><li>var hello <span class="token___x8kpoq operator___x8kpoq">=</span> name <span class="token___x8kpoq operator___x8kpoq">=</span><span class="token___x8kpoq operator___x8kpoq">></span> <span class="token___x8kpoq string___x8kpoq">\'Hello \'</span> <span class="token___x8kpoq operator___x8kpoq">+</span> name <span class="token___x8kpoq operator___x8kpoq">+</span> <span class="token___x8kpoq string___x8kpoq">\'!\'</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li></li><li>    <span class="token___x8kpoq punctuation___x8kpoq">.</span><span class="token___x8kpoq punctuation___x8kpoq">.</span><span class="token___x8kpoq punctuation___x8kpoq">.</span></li><li>    <span class="token___x8kpoq punctuation___x8kpoq">.</span><span class="token___x8kpoq punctuation___x8kpoq">.</span><span class="token___x8kpoq punctuation___x8kpoq">.</span></li><li>    <span class="token___x8kpoq punctuation___x8kpoq">.</span><span class="token___x8kpoq punctuation___x8kpoq">.</span><span class="token___x8kpoq punctuation___x8kpoq">.</span></li><li></li><li>```</li></ol>'
                                            }
                                        },
                                        {
                                            t: "ui-line",
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq comment___x8kpoq">// 文件名 ui-line.rpose</span></li><li></li><li><span class="token___x8kpoq punctuation___x8kpoq">[</span>api<span class="token___x8kpoq punctuation___x8kpoq">]</span></li><li>optionkeys <span class="token___x8kpoq operator___x8kpoq">=</span> height<span class="token___x8kpoq punctuation___x8kpoq">,</span> width<span class="token___x8kpoq punctuation___x8kpoq">,</span> color<span class="token___x8kpoq punctuation___x8kpoq">,</span> margin</li><li></li><li><span class="token___x8kpoq punctuation___x8kpoq">[</span>view<span class="token___x8kpoq punctuation___x8kpoq">]</span></li><li><span class="token___x8kpoq operator___x8kpoq">&#x3C;</span>div style<span class="token___x8kpoq operator___x8kpoq">=</span><span class="token___x8kpoq string___x8kpoq">"background-color:{color};height:{height};width:{width};margin:{margin}"</span><span class="token___x8kpoq operator___x8kpoq">></span><span class="token___x8kpoq operator___x8kpoq">&#x3C;</span><span class="token___x8kpoq operator___x8kpoq">/</span>div<span class="token___x8kpoq operator___x8kpoq">></span></li><li></li><li><span class="token___x8kpoq punctuation___x8kpoq">[</span>options<span class="token___x8kpoq punctuation___x8kpoq">]</span></li><li><span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>    height<span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq string___x8kpoq">\'1px\'</span><span class="token___x8kpoq punctuation___x8kpoq">,</span></li><li>    width<span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq string___x8kpoq">\'98%\'</span><span class="token___x8kpoq punctuation___x8kpoq">,</span></li><li>    color<span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq string___x8kpoq">\'#e6e6e6\'</span><span class="token___x8kpoq punctuation___x8kpoq">,</span></li><li>    margin<span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq string___x8kpoq">\'20px auto 20px auto\'</span><span class="token___x8kpoq punctuation___x8kpoq">,</span></li><li><span class="token___x8kpoq punctuation___x8kpoq">}</span></li><li></li><li><span class="token___x8kpoq comment___x8kpoq">// 用法，比如这样用：&#x3C;ui-line/>，或是这样用：&#x3C;ui-line height="3px" width="50%" color="#ff9408"/></span></li></ol>'
                                            }
                                        },
                                        {
                                            t: "ui-line",
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                ...
                                                height: "300px",
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq comment___x8kpoq">// 文件名 ui-button.rpose</span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[api]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li><span class="token___x8kpoq constant___x8kpoq">optionkeys</span> <span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span> onclick</span></li><li><span class="token___x8kpoq constant___x8kpoq">statekeys</span>  <span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span> value, disabled</span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[view]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>button</span> <span class="token___x8kpoq attr-name___x8kpoq">onclick</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span>{$options.onclick}</span> <span class="token___x8kpoq attr-name___x8kpoq">class</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>ui-button<span class="token___x8kpoq punctuation___x8kpoq">"</span></span> <span class="token___x8kpoq attr-name___x8kpoq">disabled</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span>{!!$state.disabled}</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>{$state.value}<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>button</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[less]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li><span class="token___x8kpoq selector___x8kpoq">.ui-button</span> <span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>    <span class="token___x8kpoq property___x8kpoq">min-width</span><span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq variable___x8kpoq">@theme-button-min-width</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>    <span class="token___x8kpoq property___x8kpoq">height</span><span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq variable___x8kpoq">@theme-button-height</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>    <span class="token___x8kpoq property___x8kpoq">border</span><span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq number___x8kpoq">1</span>px solid <span class="token___x8kpoq hexcode___x8kpoq">#999999</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>    <span class="token___x8kpoq property___x8kpoq">font-weight</span><span class="token___x8kpoq punctuation___x8kpoq">:</span> bold<span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>    <span class="token___x8kpoq property___x8kpoq">border-radius</span><span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq number___x8kpoq">3</span>px<span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>    <span class="token___x8kpoq property___x8kpoq">color</span><span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq hexcode___x8kpoq">#333333</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>    <span class="token___x8kpoq property___x8kpoq">background</span><span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq variable___x8kpoq">@theme-button-bg</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li><span class="token___x8kpoq punctuation___x8kpoq">}</span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">.ui-button:hover:not([disabled]),</li><li>.ui-button:focus</span><span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>    <span class="token___x8kpoq property___x8kpoq">background</span><span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq variable___x8kpoq">@theme-button-bg-hover</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li><span class="token___x8kpoq punctuation___x8kpoq">}</span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">.ui-button:active:not([disabled])</span><span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>    <span class="token___x8kpoq property___x8kpoq">background</span><span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq variable___x8kpoq">@theme-button-bg-active</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li><span class="token___x8kpoq punctuation___x8kpoq">}</span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">.ui-button[disabled]</span><span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>    <span class="token___x8kpoq property___x8kpoq">background</span><span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq variable___x8kpoq">@theme-button-bg-disabled</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>    <span class="token___x8kpoq property___x8kpoq">opacity</span><span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq number___x8kpoq">0.6</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>    <span class="token___x8kpoq property___x8kpoq">cursor</span><span class="token___x8kpoq punctuation___x8kpoq">:</span> not<span class="token___x8kpoq operator___x8kpoq">-</span>allowed<span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li><span class="token___x8kpoq punctuation___x8kpoq">}</span></li></ol>'
                                            }
                                        },
                                        {
                                            s: "\r\n出现了新要点，less样式里面用到了变量，比如@theme-button-min-width等，怎么来的？",
                                            k: 24
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n这关系到一个统一性思想，都各自写非常细化的独立组件，统一性又怎么解决？",
                                            k: 26
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n对于样式风格，抽象后本质上是统一使用变量，rpose把theme变量独立出来发布成npm包来用",
                                            k: 28
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n通过这种方式，解决样式风格统一性问题，也让风格的统一修改变得更直观更直接",
                                            k: 30
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n目前是点到即止，仅尝试几个变量，有机会再完善，但即使目前想要扩充也是很方便的",
                                            k: 33
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n具体例子看两个包： @gotoeasy/theme 和 rpose-theme-demo",
                                            k: 35
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n@gotoeasy/theme的目的是统一变量名，rpose-theme-demo则是个性化变量值，也可以添加个性变量",
                                            k: 37
                                        },
                                        {
                                            t: "br",
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                ...
                                                height: "300px",
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq comment___x8kpoq">// 文件名 p103-demo-component-p3d4.rpose</span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[view]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>div</span> <span class="token___x8kpoq attr-name___x8kpoq">class</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>warp<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>ul</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>        <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>{$state.msg}<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>        <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>ui-button</span> <span class="token___x8kpoq attr-name___x8kpoq">onclick</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>btn1Click<span class="token___x8kpoq punctuation___x8kpoq">"</span></span> <span class="token___x8kpoq attr-name___x8kpoq">value</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>按钮1<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">/></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>        <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>ui-button</span> <span class="token___x8kpoq attr-name___x8kpoq">onclick</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>btn2Click<span class="token___x8kpoq punctuation___x8kpoq">"</span></span> <span class="token___x8kpoq attr-name___x8kpoq">value</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>按钮2<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">/></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>        <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>ui-button</span> <span class="token___x8kpoq attr-name___x8kpoq">onclick</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>btn3Click<span class="token___x8kpoq punctuation___x8kpoq">"</span></span> <span class="token___x8kpoq attr-name___x8kpoq">@ref</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>btn3<span class="token___x8kpoq punctuation___x8kpoq">"</span></span> <span class="token___x8kpoq attr-name___x8kpoq">value</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>模拟重试<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">/></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>ul</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[state]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li><span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>  msg<span class="token___x8kpoq punctuation___x8kpoq">:</span><span class="token___x8kpoq string___x8kpoq">\'点击按钮看效果\'</span><span class="token___x8kpoq punctuation___x8kpoq">,</span></li><li>  cnt1<span class="token___x8kpoq punctuation___x8kpoq">:</span><span class="token___x8kpoq number___x8kpoq">0</span><span class="token___x8kpoq punctuation___x8kpoq">,</span></li><li>  cnt2<span class="token___x8kpoq punctuation___x8kpoq">:</span><span class="token___x8kpoq number___x8kpoq">0</span><span class="token___x8kpoq punctuation___x8kpoq">,</span></li><li><span class="token___x8kpoq punctuation___x8kpoq">}</span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[actions]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li><span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>    btn1Click<span class="token___x8kpoq punctuation___x8kpoq">:</span> e<span class="token___x8kpoq operator___x8kpoq">=></span><span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>        <span class="token___x8kpoq keyword___x8kpoq">this</span><span class="token___x8kpoq punctuation___x8kpoq">.</span>$state<span class="token___x8kpoq punctuation___x8kpoq">.</span>cnt1<span class="token___x8kpoq operator___x8kpoq">++</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>        <span class="token___x8kpoq keyword___x8kpoq">this</span><span class="token___x8kpoq punctuation___x8kpoq">.</span>$state<span class="token___x8kpoq punctuation___x8kpoq">.</span>msg <span class="token___x8kpoq operator___x8kpoq">=</span> <span class="token___x8kpoq string___x8kpoq">\'点击按钮1，共 \'</span> <span class="token___x8kpoq operator___x8kpoq">+</span> <span class="token___x8kpoq keyword___x8kpoq">this</span><span class="token___x8kpoq punctuation___x8kpoq">.</span>$state<span class="token___x8kpoq punctuation___x8kpoq">.</span>cnt1 <span class="token___x8kpoq operator___x8kpoq">+</span> <span class="token___x8kpoq string___x8kpoq">\' 次\'</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>        <span class="token___x8kpoq keyword___x8kpoq">this</span><span class="token___x8kpoq punctuation___x8kpoq">.</span><span class="token___x8kpoq function___x8kpoq">render</span><span class="token___x8kpoq punctuation___x8kpoq">(</span><span class="token___x8kpoq punctuation___x8kpoq">)</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>    <span class="token___x8kpoq punctuation___x8kpoq">}</span><span class="token___x8kpoq punctuation___x8kpoq">,</span></li><li>    btn2Click<span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq keyword___x8kpoq">function</span><span class="token___x8kpoq punctuation___x8kpoq">(</span>e<span class="token___x8kpoq punctuation___x8kpoq">)</span><span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>        <span class="token___x8kpoq keyword___x8kpoq">this</span><span class="token___x8kpoq punctuation___x8kpoq">.</span>$state<span class="token___x8kpoq punctuation___x8kpoq">.</span>cnt2<span class="token___x8kpoq operator___x8kpoq">++</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>        <span class="token___x8kpoq keyword___x8kpoq">this</span><span class="token___x8kpoq punctuation___x8kpoq">.</span>$state<span class="token___x8kpoq punctuation___x8kpoq">.</span>msg <span class="token___x8kpoq operator___x8kpoq">=</span> <span class="token___x8kpoq string___x8kpoq">\'点击按钮2，共 \'</span> <span class="token___x8kpoq operator___x8kpoq">+</span> <span class="token___x8kpoq keyword___x8kpoq">this</span><span class="token___x8kpoq punctuation___x8kpoq">.</span>$state<span class="token___x8kpoq punctuation___x8kpoq">.</span>cnt2 <span class="token___x8kpoq operator___x8kpoq">+</span> <span class="token___x8kpoq string___x8kpoq">\' 次\'</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>        <span class="token___x8kpoq keyword___x8kpoq">this</span><span class="token___x8kpoq punctuation___x8kpoq">.</span><span class="token___x8kpoq function___x8kpoq">render</span><span class="token___x8kpoq punctuation___x8kpoq">(</span><span class="token___x8kpoq punctuation___x8kpoq">)</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>    <span class="token___x8kpoq punctuation___x8kpoq">}</span><span class="token___x8kpoq punctuation___x8kpoq">,</span></li><li>    btn3Click<span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq keyword___x8kpoq">function</span><span class="token___x8kpoq punctuation___x8kpoq">(</span>e<span class="token___x8kpoq punctuation___x8kpoq">)</span><span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li></li><li>        <span class="token___x8kpoq keyword___x8kpoq">let</span> sec <span class="token___x8kpoq operator___x8kpoq">=</span> <span class="token___x8kpoq number___x8kpoq">5</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>        <span class="token___x8kpoq keyword___x8kpoq">let</span> btn3 <span class="token___x8kpoq operator___x8kpoq">=</span> <span class="token___x8kpoq keyword___x8kpoq">this</span><span class="token___x8kpoq punctuation___x8kpoq">.</span><span class="token___x8kpoq function___x8kpoq">getRefComponent</span><span class="token___x8kpoq punctuation___x8kpoq">(</span><span class="token___x8kpoq string___x8kpoq">"btn3"</span><span class="token___x8kpoq punctuation___x8kpoq">)</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>       </li><li>        btn3<span class="token___x8kpoq punctuation___x8kpoq">.</span><span class="token___x8kpoq function___x8kpoq">setState</span><span class="token___x8kpoq punctuation___x8kpoq">(</span><span class="token___x8kpoq punctuation___x8kpoq">{</span>disabled<span class="token___x8kpoq punctuation___x8kpoq">:</span><span class="token___x8kpoq boolean___x8kpoq">true</span><span class="token___x8kpoq punctuation___x8kpoq">,</span> value<span class="token___x8kpoq punctuation___x8kpoq">:</span> sec<span class="token___x8kpoq operator___x8kpoq">--</span> <span class="token___x8kpoq operator___x8kpoq">+</span> <span class="token___x8kpoq string___x8kpoq">\'秒后重试\'</span><span class="token___x8kpoq punctuation___x8kpoq">}</span><span class="token___x8kpoq punctuation___x8kpoq">)</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>        <span class="token___x8kpoq keyword___x8kpoq">let</span> tid <span class="token___x8kpoq operator___x8kpoq">=</span> <span class="token___x8kpoq function___x8kpoq">setInterval</span><span class="token___x8kpoq punctuation___x8kpoq">(</span><span class="token___x8kpoq punctuation___x8kpoq">(</span><span class="token___x8kpoq punctuation___x8kpoq">)</span><span class="token___x8kpoq operator___x8kpoq">=></span><span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>            btn3<span class="token___x8kpoq punctuation___x8kpoq">.</span><span class="token___x8kpoq function___x8kpoq">setState</span><span class="token___x8kpoq punctuation___x8kpoq">(</span><span class="token___x8kpoq punctuation___x8kpoq">{</span>disabled<span class="token___x8kpoq punctuation___x8kpoq">:</span><span class="token___x8kpoq boolean___x8kpoq">true</span><span class="token___x8kpoq punctuation___x8kpoq">,</span> value<span class="token___x8kpoq punctuation___x8kpoq">:</span> sec<span class="token___x8kpoq operator___x8kpoq">--</span> <span class="token___x8kpoq operator___x8kpoq">+</span> <span class="token___x8kpoq string___x8kpoq">\'秒后重试\'</span><span class="token___x8kpoq punctuation___x8kpoq">}</span><span class="token___x8kpoq punctuation___x8kpoq">)</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>            <span class="token___x8kpoq keyword___x8kpoq">if</span> <span class="token___x8kpoq punctuation___x8kpoq">(</span>sec <span class="token___x8kpoq operator___x8kpoq">&#x3C;</span> <span class="token___x8kpoq number___x8kpoq">0</span> <span class="token___x8kpoq punctuation___x8kpoq">)</span><span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>                <span class="token___x8kpoq function___x8kpoq">clearInterval</span><span class="token___x8kpoq punctuation___x8kpoq">(</span>tid<span class="token___x8kpoq punctuation___x8kpoq">)</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>                btn3<span class="token___x8kpoq punctuation___x8kpoq">.</span><span class="token___x8kpoq function___x8kpoq">setState</span><span class="token___x8kpoq punctuation___x8kpoq">(</span><span class="token___x8kpoq punctuation___x8kpoq">{</span>disabled<span class="token___x8kpoq punctuation___x8kpoq">:</span><span class="token___x8kpoq boolean___x8kpoq">false</span><span class="token___x8kpoq punctuation___x8kpoq">,</span> value<span class="token___x8kpoq punctuation___x8kpoq">:</span><span class="token___x8kpoq string___x8kpoq">\'模拟重试\'</span><span class="token___x8kpoq punctuation___x8kpoq">}</span><span class="token___x8kpoq punctuation___x8kpoq">)</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>            <span class="token___x8kpoq punctuation___x8kpoq">}</span></li><li>        <span class="token___x8kpoq punctuation___x8kpoq">}</span><span class="token___x8kpoq punctuation___x8kpoq">,</span> <span class="token___x8kpoq number___x8kpoq">1000</span><span class="token___x8kpoq punctuation___x8kpoq">)</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>    <span class="token___x8kpoq punctuation___x8kpoq">}</span><span class="token___x8kpoq punctuation___x8kpoq">,</span></li><li><span class="token___x8kpoq punctuation___x8kpoq">}</span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[css]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li><span class="token___x8kpoq selector___x8kpoq"><span class="token___x8kpoq class___x8kpoq">.warp</span> li</span><span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>    <span class="token___x8kpoq property___x8kpoq">margin</span><span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq number___x8kpoq">20</span>px<span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li><span class="token___x8kpoq punctuation___x8kpoq">}</span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[mount]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li>body</li></ol>'
                                            }
                                        },
                                        {
                                            s: "\r\n看效果点 ",
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                href: "p103-demo-component-p3d4.html",
                                                target: "_blank"
                                            }
                                        },
                                        {
                                        ...
                                        {
                                            s:
                                                "\r\n没有[api]声明可变属性，也就是不让外面修改，但内部自己当然是可以改state的，改完之后调用了组件的内置方法render重绘",
                                            k: 50
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n主要是那个[actions]里面有function啊，function用了this，但function却没有bind(this)！？",
                                            k: 52
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n确实，不管习惯上或事实上，都是让this指向组件对象，rpose也是这样，this一定是本组件对象",
                                            k: 55
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n既然如此，为什么还要写bind(this)呢？写bind(this)不过是再次强调，this就是本组件自己",
                                            k: 57
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s:
                                                "\r\n我不喜欢这种啰嗦的姿势，更怕万一漏写而导致出bug，所以rpose选择自动把function改成了箭头函数，放心的使用this吧",
                                            k: 59
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n        [actions]写事件函数，一个个js方法，没有特别的技术要求",
                                            k: 69
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n        [css]或[less]或[scss]写样式，样式的众多顾虑问题，rpose都帮忙铲除，还提供了theme风格方案",
                                            k: 71
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n        组件，有那么些内置方法如getState、setState、getRefComponent、getRefElement、render等",
                                            k: 73
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n        目前为止，已经能应付大部分的功能实现了，当然还有所谓的高级一点的",
                                            k: 76
                                        },
                                        {
                                            t: "br",
                    ...
                    rpose.mount(rpose.newComponentProxy("p103-demo-component").render(), "body");
                })(rpose.$$);
            },
            {
