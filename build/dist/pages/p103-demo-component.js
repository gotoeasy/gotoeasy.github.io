...
(function($$, escapeHtml) {
    ...
    // 属性接口定义
    P103DemoComponent.prototype.$OPTION_KEYS = null; // 可通过标签配置的属性，未定义则不支持外部配置
    P103DemoComponent.prototype.$STATE_KEYS = null; // 可更新的state属性，未定义则不支持外部更新state

    // 组件函数
    function P103DemoComponent(options = {}) {
        // 组件默认选项值
        this.$options = {};
        ...
        return {
            ...
            c: [
                ...
                { t: "ui-sidemenu", m: 1, k: 3 },
                {
                    ...
                    a: { class: { _189627e: 1 } },
                    c: [
                        { t: "ui-blockquote", a: { text: "3.1 内置组件 —— 代码块语法高亮组件" }, m: 1, k: 5 },
                        { s: "\r\n免不了要展示代码，吸收md格式写法的便利性，再加上highlight.js的API，rpose就这样内置了一个组件", k: 6 },
                        { t: "br", x: 1, k: 7 },
                        { s: "\r\n目前整合得还不够智能，有空会改善，但已基本能用，仿md写法嘛，很简单的\r\n", k: 8 },
                        {
                            ...
                            a: {
                                $code:
                                    '<ol><li><span class="hljs-comment">// 代码块语法高亮，例子1</span></li><li>```</li><li>var hello = name =&gt; <span class="hljs-string">\'Hello \'</span> + name + <span class="hljs-string">\'!\'</span>;</li><li>```</li></ol>'
                            },
                            m: 1,
                            k: 9
                        },
                        { s: "效果：\r\n", k: 10 },
                        {
                            ...
                            a: {
                                $code:
                                    '<ol><li><span class="hljs-keyword">var</span> hello = <span class="hljs-function"><span class="hljs-params">name</span> =&gt;</span> <span class="hljs-string">\'Hello \'</span> + name + <span class="hljs-string">\'!\'</span>;</li></ol>'
                            },
                            m: 1,
                            k: 11
                        },
                        ...
                        { s: "\r\n继续，效果就免了，仅小小区别\r\n", k: 14 },
                        {
                            ...
                            a: {
                                $code:
                                    '<ol><li><span class="hljs-comment">// 例子2，加上语言，和md一样</span></li><li>```js</li><li>var hello = name =&gt; <span class="hljs-string">\'Hello \'</span> + name + <span class="hljs-string">\'!\'</span>;</li><li>```</li><li></li><li></li><li></li><li><span class="hljs-comment">// 例子3，代码很多行的时候，得限制最大高度</span></li><li>```js max-height=<span class="hljs-number">50</span>px  <span class="hljs-comment">// 事实上写法比较随意，比如其实这样写也是一样的 ```js 50px</span></li><li>var hello = name =&gt; <span class="hljs-string">\'Hello \'</span> + name + <span class="hljs-string">\'!\'</span>;</li><li></li><li>    ...</li><li>    ...</li><li>    ...</li><li></li><li>```</li></ol>'
                            },
                            m: 1,
                            k: 15
                        },
                        { t: "ui-line", m: 1, k: 16 },
                        { t: "ui-blockquote", a: { text: "3.2 本文使用的分隔行组件" }, m: 1, k: 17 },
                        { s: "\r\n这个组件概念上等同于无状态组件，因为没有声明statekeys的具体项，状态无法修改\r\n", k: 18 },
                        {
                            t: "```",
                            a: {
                                $code:
                                    '<ol><li>// 文件名 ui-line.btf</li><li></li><li>[api]</li><li>optionkeys = <span class="hljs-built_in">height</span>, <span class="hljs-built_in">width</span>, <span class="hljs-built_in">color</span>, margin</li><li></li><li>[<span class="hljs-built_in">view</span>]</li><li>&lt;div <span class="hljs-built_in">style</span>=<span class="hljs-string">"background-color:{=color};height:{=height};width:{=width};margin:{=margin}"</span>&gt;&lt;/div&gt;</li><li></li><li>[options]</li><li>{</li><li>    <span class="hljs-built_in">height</span>: \'1px\',</li><li>    <span class="hljs-built_in">width</span>: \'<span class="hljs-number">98</span><span class="hljs-symbol">%</span>\',</li><li>    <span class="hljs-built_in">color</span>: \'#e6e6e6\',</li><li>    margin: \'20px auto 20px auto\',</li><li>}</li><li></li><li>// 用法，比如这样用：&lt;ui-line/&gt;，或是这样用：&lt;ui-line <span class="hljs-built_in">height</span>=<span class="hljs-string">"3px"</span> <span class="hljs-built_in">width</span>=<span class="hljs-string">"50%"</span> <span class="hljs-built_in">color</span>=<span class="hljs-string">"#ff9408"</span>/&gt;</li></ol>'
                            },
                            m: 1,
                            k: 19
                        },
                        { t: "ui-line", m: 1, k: 20 },
                        { t: "ui-blockquote", a: { text: "3.3 简单的按钮组件" }, m: 1, k: 21 },
                        { s: "\r\n这个按钮组件能修改状态", k: 22 },
                        { t: "br", x: 1, k: 23 },
                        { s: "\r\n通过statekeys声明看出，仅有value和disabled能改，也就是只能改按钮文字以及是否禁用\r\n", k: 24 },
                        {
                            ...
                            a: {
                                ...
                                height: "300px",
                                $code:
                                    '<ol><li><span class="hljs-comment">// 文件名 ui-button.btf</span></li><li></li><li>[api]</li><li>optionkeys = onclick</li><li>statekeys  = value, disabled</li><li></li><li>[view]</li><li>&lt;<span class="hljs-selector-tag">button</span> onclick={=<span class="hljs-variable">$options</span>.onclick} class=<span class="hljs-string">"ui-button"</span> disabled={=!!<span class="hljs-variable">$state</span>.disabled}&gt;{<span class="hljs-variable">$state</span>.value}&lt;/button&gt;</li><li></li><li>[less]</li><li><span class="hljs-selector-class">.ui-button</span> {</li><li>    <span class="hljs-attribute">min-width</span>: @theme-button-width;</li><li>    <span class="hljs-attribute">height</span>: @theme-button-height;</li><li>    <span class="hljs-attribute">border</span>: <span class="hljs-number">1px</span> solid <span class="hljs-number">#999999</span>;</li><li>    <span class="hljs-attribute">font-weight</span>: bold;</li><li>    <span class="hljs-attribute">border-radius</span>: <span class="hljs-number">3px</span>;</li><li>    <span class="hljs-attribute">color</span>: <span class="hljs-number">#333333</span>;</li><li>    <span class="hljs-attribute">background</span>: @theme-button-bg;</li><li>}</li><li></li><li><span class="hljs-selector-class">.ui-button</span>:hover:not([disabled]),</li><li><span class="hljs-selector-class">.ui-button</span>:focus{</li><li>    <span class="hljs-attribute">background</span>: @theme-button-bg-hover;</li><li>}</li><li></li><li><span class="hljs-selector-class">.ui-button</span>:active:not([disabled]){</li><li>    <span class="hljs-attribute">background</span>: @theme-button-bg-active;</li><li>}</li><li></li><li><span class="hljs-selector-class">.ui-button</span>[disabled]{</li><li>    <span class="hljs-attribute">background</span>: @theme-button-bg-disabled;</li><li>    <span class="hljs-attribute">opacity</span>: <span class="hljs-number">0.6</span>;</li><li>    <span class="hljs-attribute">cursor</span>: not-allowed;</li><li>}</li></ol>'
                            },
                            m: 1,
                            k: 25
                        },
                        { s: "\r\n出现了新要点，less样式里面用到了变量，比如@theme-button-width等，怎么来的？", k: 26 },
                        { t: "br", x: 1, k: 27 },
                        { s: "\r\n这关系到一个统一性思想，都各自写非常细化的独立组件，统一性又怎么解决？", k: 28 },
                        { t: "br", x: 1, k: 29 },
                        { s: "\r\n对于样式风格，抽象后本质上是统一使用变量，rpose把theme变量独立出来发布成npm包来用", k: 30 },
                        { t: "br", x: 1, k: 31 },
                        { s: "\r\n通过这种方式，解决样式风格统一性问题，也让风格的统一修改变得更直观更直接", k: 32 },
                        { t: "br", x: 1, k: 33 },
                        { t: "br", x: 1, k: 34 },
                        { s: "\r\n目前是点到即止，仅尝试几个变量，有机会再完善，但即使目前想要扩充也是很方便的", k: 35 },
                        { t: "br", x: 1, k: 36 },
                        { s: "\r\n具体例子看两个包： @gotoeasy/theme 和 rpose-theme-demo", k: 37 },
                        { t: "br", x: 1, k: 38 },
                        { s: "\r\n@gotoeasy/theme的目的是统一变量名，rpose-theme-demo则是个性化变量值，也可以添加个性变量", k: 39 },
                        { t: "br", x: 1, k: 40 },
                        { s: "\r\n本例的变量就是从rpose-theme-demo包中得来的\r\n\r\n\r\n", k: 41 },
                        { t: "ui-line", m: 1, k: 42 },
                        { t: "ui-blockquote", a: { text: "3.4 组装几个按钮到页面看效果" }, m: 1, k: 43 },
                        {
                            t: "```",
                            a: {
                                lang: "btf",
                                height: "300px",
                                $code:
                                    '<ol><li><span class="hljs-comment">// 文件名 demo-3-4-button.btf</span></li><li></li><li>[<span class="hljs-meta">view</span>]</li><li>&lt;div <span class="hljs-keyword">class</span>=<span class="hljs-string">"warp"</span>&gt;</li><li>    &lt;ul&gt;</li><li>        &lt;li&gt;{$state.msg}&lt;/li&gt;</li><li>        &lt;li&gt;&lt;ui-button onclick=<span class="hljs-string">"btn1Click"</span> <span class="hljs-keyword">value</span>=<span class="hljs-string">"按钮1"</span>/&gt;&lt;/li&gt;</li><li>        &lt;li&gt;&lt;ui-button onclick=<span class="hljs-string">"btn2Click"</span> <span class="hljs-keyword">value</span>=<span class="hljs-string">"按钮2"</span>/&gt;&lt;/li&gt;</li><li>        &lt;li&gt;&lt;ui-button onclick=<span class="hljs-string">"btn3Click"</span> <span class="hljs-keyword">ref</span>=<span class="hljs-string">"btn3"</span> <span class="hljs-keyword">value</span>=<span class="hljs-string">"模拟重试"</span>/&gt;&lt;/li&gt;</li><li>    &lt;/ul&gt;</li><li>&lt;/div&gt;</li><li></li><li>[<span class="hljs-meta">state</span>]</li><li>{</li><li>  msg:<span class="hljs-string">\'点击按钮看效果\'</span>,</li><li>  cnt1:<span class="hljs-number">0</span>,</li><li>  cnt2:<span class="hljs-number">0</span>,</li><li>}</li><li></li><li>[<span class="hljs-meta">actions</span>]</li><li>{</li><li>    btn1Click: e=&gt;{</li><li>        <span class="hljs-keyword">this</span>.$state.cnt1++;</li><li>        <span class="hljs-keyword">this</span>.$state.msg = <span class="hljs-string">\'点击按钮1，共 \'</span> + <span class="hljs-keyword">this</span>.$state.cnt1 + <span class="hljs-string">\' 次\'</span>;</li><li>        <span class="hljs-keyword">this</span>.render();</li><li>    },</li><li>    btn2Click: function(e){</li><li>        <span class="hljs-keyword">this</span>.$state.cnt2++;</li><li>        <span class="hljs-keyword">this</span>.$state.msg = <span class="hljs-string">\'点击按钮2，共 \'</span> + <span class="hljs-keyword">this</span>.$state.cnt2 + <span class="hljs-string">\' 次\'</span>;</li><li>        <span class="hljs-keyword">this</span>.render();</li><li>    },</li><li>    btn3Click: function(e){</li><li></li><li>        <span class="hljs-keyword">let</span> sec = <span class="hljs-number">5</span>;</li><li>        <span class="hljs-keyword">let</span> btn3 = <span class="hljs-keyword">this</span>.getRefComponent(<span class="hljs-string">"btn3"</span>);</li><li>       </li><li>        btn3.setState({disabled:<span class="hljs-literal">true</span>, <span class="hljs-keyword">value</span>: sec-- + <span class="hljs-string">\'秒后重试\'</span>});</li><li>        <span class="hljs-keyword">let</span> tid = setInterval(()=&gt;{</li><li>            btn3.setState({disabled:<span class="hljs-literal">true</span>, <span class="hljs-keyword">value</span>: sec-- + <span class="hljs-string">\'秒后重试\'</span>});</li><li>            <span class="hljs-keyword">if</span> (sec &lt; <span class="hljs-number">0</span> ){</li><li>                clearInterval(tid);</li><li>                btn3.setState({disabled:<span class="hljs-literal">false</span>, <span class="hljs-keyword">value</span>:<span class="hljs-string">\'模拟重试\'</span>});</li><li>            }</li><li>        }, <span class="hljs-number">1000</span>);</li><li>    },</li><li>}</li><li></li><li>[<span class="hljs-meta">css</span>]</li><li>.warp li{</li><li>    margin: <span class="hljs-number">20</span>px;</li><li>}</li><li></li><li>[<span class="hljs-meta">mount</span>]</li><li>body</li></ol>'
                            },
                            m: 1,
                            k: 44
                        },
                        { s: "\r\n看效果点 ", k: 45 },
                        { t: "a", a: { href: "demo-3-4-button.html", target: "_blank" }, c: [{ s: "这里", k: 47 }], x: 1, k: 46 },
                        { t: "br", x: 1, k: 48 },
                        { t: "br", x: 1, k: 49 },
                        { s: "\r\n也是有要点的", k: 50 },
                        { t: "br", x: 1, k: 51 },
                        ...
                        { t: "br", x: 1, k: 53 },
                        { s: "\r\n主要是那个[actions]里面有function啊，function用了this，但function却没有bind(this)！？", k: 54 },
                        { t: "br", x: 1, k: 55 },
                        { t: "br", x: 1, k: 56 },
                        { s: "\r\n确实，不管习惯上或事实上，都是让this指向组件对象，rpose也是这样，this一定是本组件对象", k: 57 },
                        { t: "br", x: 1, k: 58 },
                        { s: "\r\n既然如此，为什么还要写bind(this)呢？写bind(this)不过是再次强调，this就是本组件自己", k: 59 },
                        { t: "br", x: 1, k: 60 },
                        {
                        ...
                        { t: "br", x: 1, k: 62 },
                        { t: "ui-line", m: 1, k: 63 },
                        { t: "ui-blockquote", a: { text: "3.5 小结" }, m: 1, k: 64 },
                        { s: "\r\n        通过本章节，对rpose的代码写法就快接近熟练了", k: 65 },
                        { t: "br", x: 1, k: 66 },
                        { s: "\r\n        [api]声明选项配置项、声明状态可变项，不是使用时能乱改的", k: 67 },
                        { t: "br", x: 1, k: 68 },
                        { s: "\r\n        [view]就像html，模板语法很大众，免试入门", k: 69 },
                        { t: "br", x: 1, k: 70 },
                        { s: "\r\n        [actions]写事件函数，一个个js方法，没有特别的技术要求", k: 71 },
                        { t: "br", x: 1, k: 72 },
                        { s: "\r\n        [css]或[less]或[scss]写样式，样式的众多顾虑问题，rpose都帮忙铲除，还提供了theme风格方案", k: 73 },
                        { t: "br", x: 1, k: 74 },
                        { s: "\r\n        组件，有那么些内置方法如getState、setState、getRefComponent、getRefElement、render等", k: 75 },
                        { t: "br", x: 1, k: 76 },
                        { t: "br", x: 1, k: 77 },
                        { s: "\r\n        目前为止，已经能应付大部分的功能实现了，当然还有所谓的高级一点的", k: 78 },
                        { t: "br", x: 1, k: 79 },
                        { s: "\r\n        不常用的可以先放放，那么，有兴趣就可以开始动手尝试了", k: 80 },
                        { t: "br", x: 1, k: 81 },
                        { t: "ui-line", m: 1, k: 82 },
                        { t: "ui-button", a: { value: "2 第一个 hello world 组件", onclick: $actions.pre }, m: 1, k: 83 },
                        { t: "span", a: { style: "margin:0 80px 0 0" }, x: 1, k: 84 },
                        { t: "ui-button", a: { value: "4 安装，体验使用rpose", onclick: $actions.next }, m: 1, k: 85 }
                    ],
                    x: 1,
                    k: 4
                },
                { t: "ui-line", m: 1, k: 86 },
                { t: "div", a: { style: "text-align:center;margin-bottom:20px" }, c: [{ s: "青松 2018.12", k: 88 }], x: 1, k: 87 }
            ],
            x: 1,
            k: 1
        };
