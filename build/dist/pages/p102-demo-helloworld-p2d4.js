            ...
            function(require, module, exports) {
                ...
                (function($$) {
                    ...
                    rpose.registerComponents({
                        ...
                        "p102-demo-helloworld-p2d4": P102DemoHelloworldP2d4
                    }); // ------------------------------------------------------------------------------------------------------
                    // 组件 UiHelloworld
                    ...
                    // 组件 P102DemoHelloworldP2d4
                    // 注:应通过rpose.newComponentProxy方法创建组件代理对象后使用，而不是直接调用方法或用new创建
                    // ------------------------------------------------------------------------------------------------------
                    // 属性接口定义

                    P102DemoHelloworldP2d4.prototype.$OPTION_KEYS = undefined; // 可通过标签配置的属性，未定义则不支持外部配置

                    P102DemoHelloworldP2d4.prototype.$STATE_KEYS = ["$SLOT"]; // 可更新的state属性，未定义则不支持外部更新state
                    // 组件函数

                    function P102DemoHelloworldP2d4() {
                        var _this2 = this;
                        ...
                        this.$actions = {
                            fnChange: function fnChange(e) {
                                ...
                                var helloworld = _this2.getRefComponent("hello");
                    ...
                    P102DemoHelloworldP2d4.prototype.nodeTemplate = function nodeTemplate($state, $options, $actions, $this) {
                        return {
                            t: "div",
                            r: 1,
                            k: 3,
                            c: [
                                {
                                    ...
                                    a: {
                                        class: {
                                            "demo-input___1sola96": 1
                                        }
                                    },
                                    e: {
                                        change: $actions.fnChange
                                    }
                                },
                                {
                                    t: "ui-helloworld",
                    ...
                    rpose.mount(rpose.newComponentProxy("p102-demo-helloworld-p2d4").render(), "body");
                })(rpose.$$);
            },
            {
