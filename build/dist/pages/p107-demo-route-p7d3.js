            ...
            function(require, module, exports) {
                ...
                (function($$) {
                    ...
                    rpose.registerComponents({
                        ...
                        "p107-demo-route-p7d3": P107DemoRouteP7d3
                    }); // ------------------------------------------------------------------------------------------------------
                    ...
                    // 组件 P107DemoRouteP7d3
                    // 注:应通过rpose.newComponentProxy方法创建组件代理对象后使用，而不是直接调用方法或用new创建
                    // ------------------------------------------------------------------------------------------------------
                    // 属性接口定义

                    P107DemoRouteP7d3.prototype.$OPTION_KEYS = undefined; // 可通过标签配置的属性，未定义则不支持外部配置

                    P107DemoRouteP7d3.prototype.$STATE_KEYS = ["$SLOT"]; // 可更新的state属性，未定义则不支持外部更新state
                    // 组件函数

                    function P107DemoRouteP7d3() {
                        var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
                        // 组件默认选项值
                        this.$options = {}; // 组件默认数据状态值
                    ...
                    P107DemoRouteP7d3.prototype.nodeTemplate = function nodeTemplate($state, $options, $actions, $this) {
                        return {
                            t: "div",
                            r: 1,
                            k: 17,
                    ...
                    rpose.mount(rpose.newComponentProxy("p107-demo-route-p7d3").render(), "body");
                })(rpose.$$);
            },
            {
