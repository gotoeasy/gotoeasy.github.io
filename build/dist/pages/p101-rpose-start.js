        ...
        1: [
            function(require, module, exports) {
                ...
                (function($$) {
                    ...
                    P101RposeStart.prototype.$OPTION_KEYS = undefined; // 可通过标签配置的属性，未定义则不支持外部配置

                    P101RposeStart.prototype.$STATE_KEYS = ["$SLOT"]; // 可更新的state属性，未定义则不支持外部更新state
                    // 组件函数

                    function P101RposeStart() {
                        var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
                        // 组件默认选项值
                        this.$options = {}; // 组件默认数据状态值
                            ...
                            c: [
                                ...
                                },
                                {
                                    ...
                                    c: [
                                        ...
                                        {
                                            s: "\r\n        问：为何放着angular react vue等不用，还要造轮子？",
                                            k: 10
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n        答：angular太复杂，react的jsx难以忍受，vue指令太多，(回答像是有点假) ......",
                                            k: 12
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n        答：精致（精力有限简化导致^_^）、更少的概念、更多的便易、换取更多的精力关注业务实现",
                                            k: 22
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n        答：不用技能，只要基础，三驾马车 HTML/JS/CSS 大体就够了",
                                            k: 27
                                        },
                                        {
                                            t: "br",
                                        ...
                                        },
                                        {
                                            ...
                                            c: [],
                                            a: {
                                                text: "1.0 基于Block-Text-File的源码格式"
                                            }
                                        },
                                        {
                                            s: "\r\n        代码文件基于Block-Text-File格式，格式定义详见 ",
                                            k: 36
                                        },
                                        {
                                            t: "a",
                                            ...
                                            a: {
                                                href: "https://github.com/gotoeasy/block-text-file",
                                                target: "_blank"
                                            }
                                        },
                                        {
                                        ...
                                        {
                                            s: '\r\n		出于简化目的不使用其中的多文档功能，所以源码文件的后缀名统一为".rpose"，以示区别',
                                            k: 40
                                        },
                                        {
                                            t: "br",
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                lang: "rpose",
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq selector___x8kpoq">[abc]</span><span class="token___x8kpoq selector___x8kpoq"></span> <span class="token___x8kpoq comment___x8kpoq">// 块名后的内容自动忽略，可作注释用途</span></li><li>NNNNNNNNNNNNNN</li><li>NNNNNNNNNNNNNNNN</li><li>NNNNNNNNNNNNNNNNNNN</li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[def]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li>NNNNNNNNNNNNNN</li><li>NNNNNNNNNNNNNNNNNNN</li><li>NNNNNNNNNNNNNNNN</li><li><span class="token___x8kpoq comment___x8kpoq">--------- 这里用9个半角减号作为块结束行，代表[abc]的内容已结束</span></li><li><span class="token___x8kpoq comment___x8kpoq">// 结束后的内容会被忽略，作为代码文件用途也就形同注释用了</span></li><li></li><li><span class="token___x8kpoq comment___x8kpoq">更详尽的格式定义，详见 https://github.com/gotoeasy/block-text-file</span></li></ol>'
                                            }
                                        },
                                        {
                                            t: "ui-line",
                                        ...
                                        },
                                        {
                                            ...
                                            c: [],
                                            a: {
                                                text: "1.1 组件式开发，一个组件对应一个文件"
                                            }
                                        },
                                        {
                                            s: "\r\n        流行习惯，rpose简化的把一切都作组件看待，比如页面也是组件",
                                            k: 47
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n        代码文件目录组织上，有组件目录，主要是为了区分页面，因为页面最终是要打包的",
                                            k: 49
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n        rpose常用块名有[api]、[view]、[options]、[state]、[actions]、[css]、[mount]等",
                                            k: 56
                                        },
                                        {
                                            t: "br",
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                lang: "rpose",
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq selector___x8kpoq">[view]</span><span class="token___x8kpoq selector___x8kpoq"></span> <span class="token___x8kpoq comment___x8kpoq">// 写视图模板，亲近html标签的写法</span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>span</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>Hello {$state.name}, I am {$options.name}.<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>span</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>ui-button</span> <span class="token___x8kpoq attr-name___x8kpoq">value</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>确定<span class="token___x8kpoq punctuation___x8kpoq">"</span></span> <span class="token___x8kpoq attr-name___x8kpoq">onclick</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>fnClick<span class="token___x8kpoq punctuation___x8kpoq">"</span></span> <span class="token___x8kpoq punctuation___x8kpoq">/></span></span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li><span class="token___x8kpoq comment___x8kpoq">---------</span></li><li><span class="token___x8kpoq comment___x8kpoq">// 模板语法简要</span></li><li><span class="token___x8kpoq comment___x8kpoq">直接写js代码： {% /* 这里写代码 */ %}</span></li><li><span class="token___x8kpoq comment___x8kpoq">表达式： {theVar}</span></li><li><span class="token___x8kpoq comment___x8kpoq">比如</span></li><li><span class="token___x8kpoq comment___x8kpoq">{% if (条件) { %}</span></li><li><span class="token___x8kpoq comment___x8kpoq">&lt;div&gt;{name}&lt;/div&gt;</span></li><li><span class="token___x8kpoq comment___x8kpoq">{% } %}</span></li></ol>'
                                            }
                                        },
                                        {
                                            t: "@rpose/buildin:```",
                                            ...
                                            a: {
                                                lang: "rpose",
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq selector___x8kpoq">[options]</span><span class="token___x8kpoq selector___x8kpoq"></span> <span class="token___x8kpoq comment___x8kpoq">// 写默认选项数据，通常是一经设定就不会修改的内容</span></li><li><span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>    name<span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq string___x8kpoq">\'rpose\'</span></li><li><span class="token___x8kpoq punctuation___x8kpoq">}</span></li></ol>'
                                            }
                                        },
                                        {
                                            t: "@rpose/buildin:```",
                                            ...
                                            a: {
                                                lang: "rpose",
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq selector___x8kpoq">[state]</span><span class="token___x8kpoq selector___x8kpoq"></span> <span class="token___x8kpoq comment___x8kpoq">// 写默认状态数据，通常是可以被修改的内容</span></li><li><span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>    name<span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq string___x8kpoq">\'\'</span></li><li><span class="token___x8kpoq punctuation___x8kpoq">}</span></li></ol>'
                                            }
                                        },
                                        {
                                            t: "@rpose/buildin:```",
                                            ...
                                            a: {
                                                lang: "rpose",
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq selector___x8kpoq">[actions]</span><span class="token___x8kpoq selector___x8kpoq"></span> <span class="token___x8kpoq comment___x8kpoq">// 写事件响应函数，如按钮点击等</span></li><li><span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>    <span class="token___x8kpoq comment___x8kpoq">// 响应“确定”按钮点击事件，通过view中onclick的设定进行关联</span></li><li>    fnClick<span class="token___x8kpoq punctuation___x8kpoq">:</span> e <span class="token___x8kpoq operator___x8kpoq">=></span> <span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>        console<span class="token___x8kpoq punctuation___x8kpoq">.</span><span class="token___x8kpoq function___x8kpoq">info</span><span class="token___x8kpoq punctuation___x8kpoq">(</span><span class="token___x8kpoq string___x8kpoq">"点击了按钮"</span><span class="token___x8kpoq punctuation___x8kpoq">,</span> e<span class="token___x8kpoq punctuation___x8kpoq">)</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>    <span class="token___x8kpoq punctuation___x8kpoq">}</span></li><li><span class="token___x8kpoq punctuation___x8kpoq">}</span></li></ol>'
                                            }
                                        },
                                        {
                                            t: "@rpose/buildin:```",
                                            ...
                                            a: {
                                                lang: "rpose",
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq selector___x8kpoq">[css]</span><span class="token___x8kpoq selector___x8kpoq"></span> <span class="token___x8kpoq comment___x8kpoq">// 写样式表</span></li><li><span class="token___x8kpoq selector___x8kpoq"><span class="token___x8kpoq class___x8kpoq">.my-class</span></span><span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>    <span class="token___x8kpoq property___x8kpoq">color</span><span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq string___x8kpoq">\'red\'</span></li><li><span class="token___x8kpoq punctuation___x8kpoq">}</span></li></ol>'
                                            }
                                        },
                                        {
                                            t: "@rpose/buildin:```",
                                            ...
                                            a: {
                                                lang: "rpose",
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq selector___x8kpoq">[mount]</span><span class="token___x8kpoq selector___x8kpoq"></span> <span class="token___x8kpoq comment___x8kpoq">// 本组件挂载点，常用于页面显示</span></li><li>body</li></ol>'
                                            }
                                        },
                                        {
                                            s: "没错，还可以写[less]、[scss]等，不止于此",
                                            k: 69
                                        },
                                        {
                                            t: "br",
