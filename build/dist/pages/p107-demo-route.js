        ...
        1: [
            function(require, module, exports) {
                ...
                (function($$) {
                    ...
                    P107DemoRoute.prototype.$OPTION_KEYS = undefined; // 可通过标签配置的属性，未定义则不支持外部配置

                    P107DemoRoute.prototype.$STATE_KEYS = ["$SLOT"]; // 可更新的state属性，未定义则不支持外部更新state
                    // 组件函数

                    function P107DemoRoute() {
                        var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
                        // 组件默认选项值
                        this.$options = {}; // 组件默认数据状态值
                    ...
                    P107DemoRoute.prototype.nodeTemplate = function nodeTemplate($state, $options, $actions, $this) {
                        return {
                            t: "div",
                            r: 1,
                            k: 128,
                            c: [
                                ...
                                },
                                {
                                    ...
                                    c: [
                                        ...
                                        {
                                            s: "\r\n前端路由没有标准，都是按经验自由发挥，差异体现在不同的接口设计",
                                            k: 4
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n各自造轮子的极端，一种是简陋，附上例子说几行代码就能搞定，讲原理的层次",
                                            k: 6
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n另一种是过度设计，追求无限的灵活性，为了路由而路由，谈艺术的层次",
                                            k: 8
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n前端路由本质上是为了支持浏览器的前进后退操作，能模拟页面跳转但又不跳出当前SPA页",
                                            k: 11
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n因此，rpose控制复杂度，注重易用性，不会一股脑的支持各种功能",
                                            k: 13
                                        },
                                        {
                                            t: "br",
                                            ...
                                            c: [
                                                {
                                                    ...
                                                    c: [
                                                        {
                                                            s: "使用锚点hash模式，暂不支持history模式，因为history模式刷新时需要服务端配合，不科学",
                                                            k: 15
                                                        }
                                                    ]
                                                },
                                                {
                                                    ...
                                                    c: [
                                                        {
                                                            s:
                                                                "不支持显式传参，比如#user/:id或#product?code=123，直接暴露业务数据，不安全。通过隐式参数或哈希化参数的方式解决",
                                                            k: 17
                                                        }
                                                    ]
                                                },
                                                {
                                                    ...
                                                    c: [
                                                        {
                                                            s: "不支持嵌套路由，每看到一个地址或嵌套组件，需要脑筋也同步嵌套配合，过于复杂化",
                                                            k: 19
                                                        }
                                                    ]
                                                },
                                                {
                                                    ...
                                                    c: [
                                                        {
                                                            s: "自动检查判断，支持historyApi则优先使用，否则使用hashchange方式实现前端路由",
                                                            k: 21
                                                        }
                                                    ]
                                                },
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                lang: "rpose",
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq comment___x8kpoq">// p107-demo-route-p7d2.rpose 简单拼装三个页面组件为一个SPA页面</span></li><li><span class="token___x8kpoq selector___x8kpoq">[view]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>ul</span><span class="token___x8kpoq style-attr___x8kpoq language-css___x8kpoq"><span class="token___x8kpoq attr-name___x8kpoq"> <span class="token___x8kpoq attr-name___x8kpoq">style</span></span><span class="token___x8kpoq punctuation___x8kpoq">="</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq property___x8kpoq">list-style</span><span class="token___x8kpoq punctuation___x8kpoq">:</span>none</span><span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>        <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>a</span> <span class="token___x8kpoq attr-name___x8kpoq">href</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>#helloworld<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>helloworld<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>a</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>        <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>a</span> <span class="token___x8kpoq attr-name___x8kpoq">href</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>#component<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>component<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>a</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>        <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>a</span> <span class="token___x8kpoq attr-name___x8kpoq">href</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>#slot<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>slot<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>a</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>ul</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>helloworld<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>p102-demo-helloworld-p2d2</span><span class="token___x8kpoq punctuation___x8kpoq">/></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>component<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>p103-demo-component-p3d4</span><span class="token___x8kpoq punctuation___x8kpoq">/></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>slot<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>p106-demo-slot-p6d2</span><span class="token___x8kpoq punctuation___x8kpoq">/></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[mount]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li>body</li></ol>'
                                            }
                                        },
                                        {
                                            s: "\r\n这个组件就是简单的把三个页面组件拼成一个SPA页面",
                                            k: 36
                                        },
                                        {
                                            t: "br",
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                href: "p107-demo-route-p7d2.html",
                                                target: "_blank"
                                            }
                                        },
                                        {
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                href: "p107-demo-route-p7d2.html#component",
                                                target: "_blank"
                                            }
                                        },
                                        {
                                        ...
                                        {
                                            s: "\r\n初次加载SPA时，如果地址有误，但仍旧希望显示默认路由，要满足这个功能加上default属性声明即可",
                                            k: 47
                                        },
                                        {
                                            t: "br",
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                lang: "rpose",
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq comment___x8kpoq">// p107-demo-route-p7d3.rpose</span></li><li><span class="token___x8kpoq selector___x8kpoq">[view]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>ul</span><span class="token___x8kpoq style-attr___x8kpoq language-css___x8kpoq"><span class="token___x8kpoq attr-name___x8kpoq"> <span class="token___x8kpoq attr-name___x8kpoq">style</span></span><span class="token___x8kpoq punctuation___x8kpoq">="</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq property___x8kpoq">list-style</span><span class="token___x8kpoq punctuation___x8kpoq">:</span>none</span><span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>        <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>a</span> <span class="token___x8kpoq attr-name___x8kpoq">href</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>#helloworld<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>helloworld<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>a</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>        <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>a</span> <span class="token___x8kpoq attr-name___x8kpoq">href</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>#component<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>component<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>a</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>        <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>a</span> <span class="token___x8kpoq attr-name___x8kpoq">href</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>#slot<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>slot<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>a</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>ul</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>helloworld<span class="token___x8kpoq punctuation___x8kpoq">"</span></span> <span class="token___x8kpoq attr-name___x8kpoq">default</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>p102-demo-helloworld-p2d2</span><span class="token___x8kpoq punctuation___x8kpoq">/></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>component<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>p103-demo-component-p3d4</span><span class="token___x8kpoq punctuation___x8kpoq">/></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>slot<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>p106-demo-slot-p6d2</span><span class="token___x8kpoq punctuation___x8kpoq">/></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[mount]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li>body</li></ol>'
                                            }
                                        },
                                        {
                                            s: "\r\n默认路由为helloworld，初期打开指定不存在的foo路由，将会显示默认页，",
                                            k: 50
                                        },
                                        {
                                            t: "a",
                                            ...
                                            a: {
                                                href: "p107-demo-route-p7d3.html#foo",
                                                target: "_blank"
                                            }
                                        },
                                        {
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                lang: "rpose",
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq comment___x8kpoq">// p107-demo-route-p7d4.rpose</span></li><li><span class="token___x8kpoq selector___x8kpoq">[view]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>ul</span><span class="token___x8kpoq style-attr___x8kpoq language-css___x8kpoq"><span class="token___x8kpoq attr-name___x8kpoq"> <span class="token___x8kpoq attr-name___x8kpoq">style</span></span><span class="token___x8kpoq punctuation___x8kpoq">="</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq property___x8kpoq">list-style</span><span class="token___x8kpoq punctuation___x8kpoq">:</span>none</span><span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>        <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>a</span> <span class="token___x8kpoq attr-name___x8kpoq">href</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>#helloworld<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>helloworld<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>a</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>        <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>a</span> <span class="token___x8kpoq attr-name___x8kpoq">href</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>#component<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>component<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>a</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>        <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>a</span> <span class="token___x8kpoq attr-name___x8kpoq">href</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>#slot<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>slot<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>a</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>        <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>a</span> <span class="token___x8kpoq attr-name___x8kpoq">href</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>#bar<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>bar<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>a</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>ul</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>helloworld<span class="token___x8kpoq punctuation___x8kpoq">"</span></span> <span class="token___x8kpoq attr-name___x8kpoq">default</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>p102-demo-helloworld-p2d2</span><span class="token___x8kpoq punctuation___x8kpoq">/></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>component<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>p103-demo-component-p3d4</span><span class="token___x8kpoq punctuation___x8kpoq">/></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>slot<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>p106-demo-slot-p6d2</span><span class="token___x8kpoq punctuation___x8kpoq">/></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">notfound</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>div</span><span class="token___x8kpoq style-attr___x8kpoq language-css___x8kpoq"><span class="token___x8kpoq attr-name___x8kpoq"> <span class="token___x8kpoq attr-name___x8kpoq">style</span></span><span class="token___x8kpoq punctuation___x8kpoq">="</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq property___x8kpoq">color</span><span class="token___x8kpoq punctuation___x8kpoq">:</span>red<span class="token___x8kpoq punctuation___x8kpoq">;</span><span class="token___x8kpoq property___x8kpoq">font-size</span><span class="token___x8kpoq punctuation___x8kpoq">:</span><span class="token___x8kpoq number___x8kpoq">5</span>rem<span class="token___x8kpoq punctuation___x8kpoq">;</span></span><span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>b</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>404<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>b</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[mount]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li>body</li></ol>'
                                            }
                                        },
                                        {
                                            s: "\r\n打开后点击bar，由于不存在bar的路由，将显示notfound页，地址栏直接输入错误地址也是同样，",
                                            k: 58
                                        },
                                        {
                                            t: "a",
                                            ...
                                            a: {
                                                href: "p107-demo-route-p7d4.html",
                                                target: "_blank"
                                            }
                                        },
                                        {
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                lang: "rpose",
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq comment___x8kpoq">// p107-demo-route-p7d5.rpose</span></li><li><span class="token___x8kpoq selector___x8kpoq">[view]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>*<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>        <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>ul</span><span class="token___x8kpoq style-attr___x8kpoq language-css___x8kpoq"><span class="token___x8kpoq attr-name___x8kpoq"> <span class="token___x8kpoq attr-name___x8kpoq">style</span></span><span class="token___x8kpoq punctuation___x8kpoq">="</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq property___x8kpoq">list-style</span><span class="token___x8kpoq punctuation___x8kpoq">:</span>none</span><span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>            <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>a</span> <span class="token___x8kpoq attr-name___x8kpoq">href</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>#helloworld<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>helloworld<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>a</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>            <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>a</span> <span class="token___x8kpoq attr-name___x8kpoq">href</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>#component<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>component<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>a</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>            <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>a</span> <span class="token___x8kpoq attr-name___x8kpoq">href</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>#slot<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>slot<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>a</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>            <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>a</span> <span class="token___x8kpoq attr-name___x8kpoq">href</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>#foobar<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>foobar<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>a</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>        <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>ul</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>helloworld<span class="token___x8kpoq punctuation___x8kpoq">"</span></span> <span class="token___x8kpoq attr-name___x8kpoq">default</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>p102-demo-helloworld-p2d2</span><span class="token___x8kpoq punctuation___x8kpoq">/></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>component<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>p103-demo-component-p3d4</span><span class="token___x8kpoq punctuation___x8kpoq">/></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>slot<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>p106-demo-slot-p6d2</span><span class="token___x8kpoq punctuation___x8kpoq">/></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">notfound</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>div</span><span class="token___x8kpoq style-attr___x8kpoq language-css___x8kpoq"><span class="token___x8kpoq attr-name___x8kpoq"> <span class="token___x8kpoq attr-name___x8kpoq">style</span></span><span class="token___x8kpoq punctuation___x8kpoq">="</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq property___x8kpoq">color</span><span class="token___x8kpoq punctuation___x8kpoq">:</span>red<span class="token___x8kpoq punctuation___x8kpoq">;</span><span class="token___x8kpoq property___x8kpoq">font-size</span><span class="token___x8kpoq punctuation___x8kpoq">:</span><span class="token___x8kpoq number___x8kpoq">5</span>rem<span class="token___x8kpoq punctuation___x8kpoq">;</span></span><span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>b</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>404<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>b</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>foo*<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>div</span><span class="token___x8kpoq style-attr___x8kpoq language-css___x8kpoq"><span class="token___x8kpoq attr-name___x8kpoq"> <span class="token___x8kpoq attr-name___x8kpoq">style</span></span><span class="token___x8kpoq punctuation___x8kpoq">="</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq property___x8kpoq">font-size</span><span class="token___x8kpoq punctuation___x8kpoq">:</span><span class="token___x8kpoq number___x8kpoq">3</span>rem<span class="token___x8kpoq punctuation___x8kpoq">;</span></span><span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>b</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>foobar<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>b</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[mount]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li>body</li></ol>'
                                            }
                                        },
                                        {
                                            s:
                                                "\r\n路由匹配顺序无关、数量无关，可以同时匹配多个，全部匹配的都会被显示\r\n本例同时匹配2个路由，将会一起显示，打开后点击foobar ",
                                            k: 67
                                        },
                                        {
                                            t: "a",
                                            ...
                                            a: {
                                                href: "p107-demo-route-p7d5.html",
                                                target: "_blank"
                                            }
                                        },
                                        {
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                lang: "rpose",
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq comment___x8kpoq">// p107-demo-route-p7d6.rpose</span></li><li><span class="token___x8kpoq selector___x8kpoq">[view]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>*<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>        <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>ul</span><span class="token___x8kpoq style-attr___x8kpoq language-css___x8kpoq"><span class="token___x8kpoq attr-name___x8kpoq"> <span class="token___x8kpoq attr-name___x8kpoq">style</span></span><span class="token___x8kpoq punctuation___x8kpoq">="</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq property___x8kpoq">list-style</span><span class="token___x8kpoq punctuation___x8kpoq">:</span>none</span><span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>            <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router-link</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>helloworld<span class="token___x8kpoq punctuation___x8kpoq">"</span></span> <span class="token___x8kpoq attr-name___x8kpoq">text</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>helloworld<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">/></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>            <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router-link</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>foo<span class="token___x8kpoq punctuation___x8kpoq">"</span></span> <span class="token___x8kpoq attr-name___x8kpoq">text</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>foo<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">/></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>            <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router-link</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>bar<span class="token___x8kpoq punctuation___x8kpoq">"</span></span> <span class="token___x8kpoq attr-name___x8kpoq">text</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>bar<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">/></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>        <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>ul</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>helloworld<span class="token___x8kpoq punctuation___x8kpoq">"</span></span> <span class="token___x8kpoq attr-name___x8kpoq">default</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>p102-demo-helloworld-p2d2</span><span class="token___x8kpoq punctuation___x8kpoq">/></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>foo<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>div</span><span class="token___x8kpoq style-attr___x8kpoq language-css___x8kpoq"><span class="token___x8kpoq attr-name___x8kpoq"> <span class="token___x8kpoq attr-name___x8kpoq">style</span></span><span class="token___x8kpoq punctuation___x8kpoq">="</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq property___x8kpoq">font-size</span><span class="token___x8kpoq punctuation___x8kpoq">:</span><span class="token___x8kpoq number___x8kpoq">3</span>rem<span class="token___x8kpoq punctuation___x8kpoq">;</span></span><span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>b</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>foo<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>b</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>bar<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>div</span><span class="token___x8kpoq style-attr___x8kpoq language-css___x8kpoq"><span class="token___x8kpoq attr-name___x8kpoq"> <span class="token___x8kpoq attr-name___x8kpoq">style</span></span><span class="token___x8kpoq punctuation___x8kpoq">="</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq property___x8kpoq">font-size</span><span class="token___x8kpoq punctuation___x8kpoq">:</span><span class="token___x8kpoq number___x8kpoq">3</span>rem<span class="token___x8kpoq punctuation___x8kpoq">;</span></span><span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>b</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>bar<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>b</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">notfound</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>div</span><span class="token___x8kpoq style-attr___x8kpoq language-css___x8kpoq"><span class="token___x8kpoq attr-name___x8kpoq"> <span class="token___x8kpoq attr-name___x8kpoq">style</span></span><span class="token___x8kpoq punctuation___x8kpoq">="</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq property___x8kpoq">color</span><span class="token___x8kpoq punctuation___x8kpoq">:</span>red<span class="token___x8kpoq punctuation___x8kpoq">;</span><span class="token___x8kpoq property___x8kpoq">font-size</span><span class="token___x8kpoq punctuation___x8kpoq">:</span><span class="token___x8kpoq number___x8kpoq">5</span>rem<span class="token___x8kpoq punctuation___x8kpoq">;</span></span><span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>b</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>404<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>b</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[mount]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li>body</li></ol>'
                                            }
                                        },
                                        {
                                            s: "\r\n本例router-link组件接受path和text属性，分别代表链接和显示的文本 ",
                                            k: 76
                                        },
                                        {
                                            t: "a",
                                            ...
                                            a: {
                                                href: "p107-demo-route-p7d6.html",
                                                target: "_blank"
                                            }
                                        },
                                        {
                                        ...
                                        {
                                            s: "\r\n参数传递，组件router-link按传参方式传入params属性即可，效果上在地址栏不会直接暴露数据",
                                            k: 81
                                        },
                                        {
                                            t: "br",
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                lang: "rpose",
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq comment___x8kpoq">// p107-demo-route-p7d7.rpose</span></li><li><span class="token___x8kpoq selector___x8kpoq">[view]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>*<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>        <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>ul</span><span class="token___x8kpoq style-attr___x8kpoq language-css___x8kpoq"><span class="token___x8kpoq attr-name___x8kpoq"> <span class="token___x8kpoq attr-name___x8kpoq">style</span></span><span class="token___x8kpoq punctuation___x8kpoq">="</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq property___x8kpoq">list-style</span><span class="token___x8kpoq punctuation___x8kpoq">:</span>none</span><span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>            <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>&#x3C;router-link path="foo" params={{id:\'id-001\'}} text="foo"/><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>            <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router-link</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>bar<span class="token___x8kpoq punctuation___x8kpoq">"</span></span> <span class="token___x8kpoq attr-name___x8kpoq">text</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>bar<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">/></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>li</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>        <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>ul</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>foo<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>div</span><span class="token___x8kpoq style-attr___x8kpoq language-css___x8kpoq"><span class="token___x8kpoq attr-name___x8kpoq"> <span class="token___x8kpoq attr-name___x8kpoq">style</span></span><span class="token___x8kpoq punctuation___x8kpoq">="</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq property___x8kpoq">font-size</span><span class="token___x8kpoq punctuation___x8kpoq">:</span><span class="token___x8kpoq number___x8kpoq">3</span>rem<span class="token___x8kpoq punctuation___x8kpoq">;</span></span><span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>b</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>foo<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>b</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>br</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>id: {$state.id}<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>router</span> <span class="token___x8kpoq attr-name___x8kpoq">path</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>bar<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>div</span><span class="token___x8kpoq style-attr___x8kpoq language-css___x8kpoq"><span class="token___x8kpoq attr-name___x8kpoq"> <span class="token___x8kpoq attr-name___x8kpoq">style</span></span><span class="token___x8kpoq punctuation___x8kpoq">="</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq property___x8kpoq">font-size</span><span class="token___x8kpoq punctuation___x8kpoq">:</span><span class="token___x8kpoq number___x8kpoq">3</span>rem<span class="token___x8kpoq punctuation___x8kpoq">;</span></span><span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>b</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span>bar<span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>b</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>router</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[state]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li><span class="token___x8kpoq punctuation___x8kpoq">{</span>id<span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq string___x8kpoq">\'\'</span><span class="token___x8kpoq punctuation___x8kpoq">}</span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[methods]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li><span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>    init<span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq punctuation___x8kpoq">(</span><span class="token___x8kpoq punctuation___x8kpoq">)</span> <span class="token___x8kpoq operator___x8kpoq">=></span> <span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>        rpose<span class="token___x8kpoq punctuation___x8kpoq">.</span><span class="token___x8kpoq function___x8kpoq">on</span><span class="token___x8kpoq punctuation___x8kpoq">(</span><span class="token___x8kpoq string___x8kpoq">\'router.onroute\'</span><span class="token___x8kpoq punctuation___x8kpoq">,</span> ctx <span class="token___x8kpoq operator___x8kpoq">=></span> <span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>            <span class="token___x8kpoq keyword___x8kpoq">let</span> path <span class="token___x8kpoq operator___x8kpoq">=</span> ctx<span class="token___x8kpoq punctuation___x8kpoq">.</span>path<span class="token___x8kpoq punctuation___x8kpoq">;</span>        <span class="token___x8kpoq comment___x8kpoq">// 这是router-link标签中传递的path值</span></li><li>            <span class="token___x8kpoq keyword___x8kpoq">let</span> state <span class="token___x8kpoq operator___x8kpoq">=</span> ctx<span class="token___x8kpoq punctuation___x8kpoq">.</span>state<span class="token___x8kpoq punctuation___x8kpoq">;</span>      <span class="token___x8kpoq comment___x8kpoq">// 这是router-link标签中传递的params值</span></li><li>            path <span class="token___x8kpoq operator___x8kpoq">==</span> <span class="token___x8kpoq string___x8kpoq">\'foo\'</span> <span class="token___x8kpoq operator___x8kpoq">&#x26;&#x26;</span> <span class="token___x8kpoq punctuation___x8kpoq">(</span><span class="token___x8kpoq keyword___x8kpoq">this</span><span class="token___x8kpoq punctuation___x8kpoq">.</span>$state<span class="token___x8kpoq punctuation___x8kpoq">.</span>id <span class="token___x8kpoq operator___x8kpoq">=</span> state<span class="token___x8kpoq punctuation___x8kpoq">.</span>id<span class="token___x8kpoq punctuation___x8kpoq">)</span> <span class="token___x8kpoq operator___x8kpoq">&#x26;&#x26;</span> <span class="token___x8kpoq keyword___x8kpoq">this</span><span class="token___x8kpoq punctuation___x8kpoq">.</span><span class="token___x8kpoq function___x8kpoq">render</span><span class="token___x8kpoq punctuation___x8kpoq">(</span><span class="token___x8kpoq boolean___x8kpoq">true</span><span class="token___x8kpoq punctuation___x8kpoq">)</span><span class="token___x8kpoq punctuation___x8kpoq">;</span>   <span class="token___x8kpoq comment___x8kpoq">// 激活foo页时更新显示id</span></li><li>        <span class="token___x8kpoq punctuation___x8kpoq">}</span><span class="token___x8kpoq punctuation___x8kpoq">)</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>    <span class="token___x8kpoq punctuation___x8kpoq">}</span></li><li><span class="token___x8kpoq punctuation___x8kpoq">}</span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[mount]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li>body</li></ol>'
                                            }
                                        },
                                        {
                                            s: "\r\n打开后点击foo链接 ",
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                href: "p107-demo-route-p7d7.html",
                                                target: "_blank"
                                            }
                                        },
                                        {
                                        ...
                                        {
                                            s:
                                                "\r\n对于不支持historyApi的浏览器环境，传参数时地址栏将自动添加哈希串避免数据安全问题，同时也能避免参数过长的错误发生",
                                            k: 88
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n本例出现事件router.onroute，在路由切换时将被触发",
                                            k: 91
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s:
                                                "\r\n另外，这里用到了[methods]块定义，和[actions]的区别是，[methods]中定义的方法会都会被转译为组件对象的方法",
                                            k: 94
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n在[methods]中的init方法名是约定的初始方法，对象创建后就会被调用，所以可以用来安装相关事件",
                                            k: 96
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s:
                                                "\r\n在[methods]中定义的方法如果和内置方法名重复，将会替代原内置方法，比如可以自定义render方法替代默认的render处理逻辑",
                                            k: 98
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n        前端路由的技术原理虽然简单，但实现方式没有标准，自由发挥，rpose的定位是简便易用",
                                            k: 106
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n        提供路由组件、路由链接组件、路由事件，没有花哨功能，基本满足常见业务需求",
                                            k: 108
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n        优先使用historyApi实现hash模式路由，隐式传参避免数据安全问题",
                                            k: 110
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n        [methods]块定义组件方法的作用，及特殊的init方法的用途",
                                            k: 117
                                        },
                                        {
                                            t: "br",
                    ...
                    rpose.mount(rpose.newComponentProxy("p107-demo-route").render(), "body");
                })(rpose.$$);
            },
            {
