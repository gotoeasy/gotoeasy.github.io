            ...
            function(require, module, exports) {
                ...
                (function($$) {
                    ...
                    rpose.registerComponents({
                        "p105-demo-prerender-p5d3": P105DemoPrerenderP5d3
                    }); // ------------------------------------------------------------------------------------------------------
                    // 组件 P105DemoPrerenderP5d3
                    // 注:应通过rpose.newComponentProxy方法创建组件代理对象后使用，而不是直接调用方法或用new创建
                    // ------------------------------------------------------------------------------------------------------
                    // 属性接口定义

                    P105DemoPrerenderP5d3.prototype.$OPTION_KEYS = undefined; // 可通过标签配置的属性，未定义则不支持外部配置

                    P105DemoPrerenderP5d3.prototype.$STATE_KEYS = ["$SLOT"]; // 可更新的state属性，未定义则不支持外部更新state
                    // 组件函数

                    function P105DemoPrerenderP5d3() {
                    ...
                    P105DemoPrerenderP5d3.prototype.nodeTemplate = function nodeTemplate($state, $options, $actions, $this) {
                        return {
                            t: "img",
                            r: 1,
                            k: 1,
                    ...
                    rpose.mount(rpose.newComponentProxy("p105-demo-prerender-p5d3").render(), "body");
                })(rpose.$$);
            },
            {
