            ...
            function(require, module, exports) {
                ...
                (function($$) {
                    ...
                    rpose.registerComponents({
                        ...
                        "p107-demo-route-p7d7": P107DemoRouteP7d7
                    }); // ------------------------------------------------------------------------------------------------------
                    ...
                    // 组件 P107DemoRouteP7d7
                    // 注:应通过rpose.newComponentProxy方法创建组件代理对象后使用，而不是直接调用方法或用new创建
                    // ------------------------------------------------------------------------------------------------------
                    // 属性接口定义

                    P107DemoRouteP7d7.prototype.$OPTION_KEYS = undefined; // 可通过标签配置的属性，未定义则不支持外部配置

                    P107DemoRouteP7d7.prototype.$STATE_KEYS = ["$SLOT"]; // 可更新的state属性，未定义则不支持外部更新state
                    // 组件函数

                    function P107DemoRouteP7d7() {
                        var _this4 = this;
                        ...
                        this.init = function() {
                            rpose.on("router.onroute", function(ctx) {
                                var path = ctx.path;
                                var state = ctx.state;
                                path == "foo" && (_this4.$state.id = state.id) && _this4.render(true);
                            });
                        };
                    }
                    /**
                    ...
                    P107DemoRouteP7d7.prototype.nodeTemplate = function nodeTemplate($state, $options, $actions, $this) {
                        return {
                            t: "div",
                            r: 1,
                            k: 17,
                    ...
                    rpose.mount(rpose.newComponentProxy("p107-demo-route-p7d7").render(), "body");
                })(rpose.$$);
            },
            {
