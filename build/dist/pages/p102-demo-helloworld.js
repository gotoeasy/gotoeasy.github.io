            ...
            function(require, module, exports) {
                ...
                (function($$) {
                    ...
                    rpose.registerComponents({
                        ...
                        "p102-demo-helloworld": P102DemoHelloworld
                    }); // ------------------------------------------------------------------------------------------------------
                    // 组件 $rpose$buildin$$$$
                    ...
                    // 组件 P102DemoHelloworld
                    // 注:应通过rpose.newComponentProxy方法创建组件代理对象后使用，而不是直接调用方法或用new创建
                    // ------------------------------------------------------------------------------------------------------
                    // 属性接口定义

                    P102DemoHelloworld.prototype.$OPTION_KEYS = undefined; // 可通过标签配置的属性，未定义则不支持外部配置

                    P102DemoHelloworld.prototype.$STATE_KEYS = ["$SLOT"]; // 可更新的state属性，未定义则不支持外部更新state
                    // 组件函数

                    function P102DemoHelloworld() {
                        var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
                        // 组件默认选项值
                        this.$options = {}; // 组件默认数据状态值
                    ...
                    P102DemoHelloworld.prototype.nodeTemplate = function nodeTemplate($state, $options, $actions, $this) {
                        return {
                            t: "div",
                            r: 1,
                            k: 88,
                            c: [
                                ...
                                },
                                {
                                    ...
                                    c: [
                                        ...
                                        {
                                            s: "\r\n组件名根据文件名转换而来，即 UiHelloworld，也就是意味着文件名不能乱写特殊字符，这应该不算事",
                                            k: 7
                                        },
                                        {
                                            t: "br",
                                        ...
                                        },
                                        {
                                            ...
                                            c: [],
                                            a: {
                                                text: "2.2 使用 hello world 组件"
                                            }
                                        },
                                        {
                                            s: "\r\n为了看到 hello world 的效果，简单写一个页面",
                                            k: 11
                                        },
                                        {
                                            t: "br",
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                lang: "rpose",
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq comment___x8kpoq">// 文件名 p102-demo-helloworld-p2d2.rpose</span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[view]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>ui-helloworld</span><span class="token___x8kpoq punctuation___x8kpoq">/></span></span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[mount]</span><span class="token___x8kpoq selector___x8kpoq"></span> <span class="token___x8kpoq comment___x8kpoq">// 挂载显示</span></li><li>body</li></ol>'
                                            }
                                        },
                                        {
                                            s: "这便是把 hello world 组件用起来了，效果用想，显示出“hello world!”而已，不信点 ",
                                            k: 15
                                        },
                                        {
                                            t: "a",
                                            ...
                                            a: {
                                                href: "p102-demo-helloworld-p2d2.html",
                                                target: "_blank"
                                            }
                                        },
                                        {
                                        ...
                                        },
                                        {
                                            ...
                                            c: [],
                                            a: {
                                                text: "2.3 修改 hello world 组件状态"
                                            }
                                        },
                                        {
                                            s: "\r\n要修改组件状态，3个要素，什么组件？什么时机？改成什么？",
                                            k: 20
                                        },
                                        {
                                            t: "br",
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                lang: "rpose",
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq comment___x8kpoq">// 文件名 p102-demo-helloworld-p2d3.rpose</span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[view]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>input</span> <span class="token___x8kpoq attr-name___x8kpoq">onchange</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>fnChange<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>ui-helloworld</span> <span class="token___x8kpoq attr-name___x8kpoq">@ref</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>hello<span class="token___x8kpoq punctuation___x8kpoq">"</span></span> <span class="token___x8kpoq attr-name___x8kpoq">name</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>rpose<span class="token___x8kpoq punctuation___x8kpoq">"</span></span> <span class="token___x8kpoq punctuation___x8kpoq">/></span></span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[actions]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li><span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>    fnChange<span class="token___x8kpoq punctuation___x8kpoq">:</span> e<span class="token___x8kpoq operator___x8kpoq">=></span> <span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>        <span class="token___x8kpoq keyword___x8kpoq">let</span> txt <span class="token___x8kpoq operator___x8kpoq">=</span> e<span class="token___x8kpoq punctuation___x8kpoq">.</span>target<span class="token___x8kpoq punctuation___x8kpoq">.</span>value<span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>        <span class="token___x8kpoq keyword___x8kpoq">let</span> helloworld <span class="token___x8kpoq operator___x8kpoq">=</span> <span class="token___x8kpoq keyword___x8kpoq">this</span><span class="token___x8kpoq punctuation___x8kpoq">.</span><span class="token___x8kpoq function___x8kpoq">getRefComponent</span><span class="token___x8kpoq punctuation___x8kpoq">(</span><span class="token___x8kpoq string___x8kpoq">\'hello\'</span><span class="token___x8kpoq punctuation___x8kpoq">)</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>        helloworld<span class="token___x8kpoq punctuation___x8kpoq">.</span><span class="token___x8kpoq function___x8kpoq">setState</span><span class="token___x8kpoq punctuation___x8kpoq">(</span><span class="token___x8kpoq punctuation___x8kpoq">{</span>name<span class="token___x8kpoq punctuation___x8kpoq">:</span>txt<span class="token___x8kpoq punctuation___x8kpoq">}</span><span class="token___x8kpoq punctuation___x8kpoq">)</span><span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>    <span class="token___x8kpoq punctuation___x8kpoq">}</span></li><li><span class="token___x8kpoq punctuation___x8kpoq">}</span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[mount]</span><span class="token___x8kpoq selector___x8kpoq"></span> <span class="token___x8kpoq comment___x8kpoq">// 挂载显示</span></li><li>body</li></ol>'
                                            }
                                        },
                                        {
                                            s: "\r\n要点1，事件的绑定，沿用html习惯直接写onchange的，处理函数是写在[actions]里的，通过名称关联起来的",
                                            k: 24
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n要点2，取组件对象，设定@ref属性，组件对象默认提供getRefComponent方法可用",
                                            k: 26
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n要点3，修改状态，沿用习惯通过组件的setState方法实现",
                                            k: 28
                                        },
                                        {
                                            t: "br",
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                href: "p102-demo-helloworld-p2d3.html",
                                                target: "_blank"
                                            }
                                        },
                                        {
                                        ...
                                        {
                                            s:
                                                "\r\n扩充点1，组件根部是一个标签节点，多了不行。为什么要这样，习惯...其实主要是影响虚拟节点比较的算法实现",
                                            k: 36
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s:
                                                "\r\n扩充点2，还有getRefComponents方法，返回的是数组，还有getRefElements、getRefElement方法，对应返回真实Dom",
                                            k: 38
                                        },
                                        {
                                            t: "br",
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                lang: "rpose",
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq comment___x8kpoq">// 文件名 p102-demo-helloworld-p2d4.rpose</span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[view]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>input</span> <span class="token___x8kpoq attr-name___x8kpoq">class</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>demo-input<span class="token___x8kpoq punctuation___x8kpoq">"</span></span> <span class="token___x8kpoq attr-name___x8kpoq">onchange</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>fnChange<span class="token___x8kpoq punctuation___x8kpoq">"</span></span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li>    <span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;</span>ui-helloworld</span> <span class="token___x8kpoq attr-name___x8kpoq">@ref</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>hello<span class="token___x8kpoq punctuation___x8kpoq">"</span></span> <span class="token___x8kpoq attr-name___x8kpoq">name</span><span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">=</span><span class="token___x8kpoq punctuation___x8kpoq">"</span>rpose<span class="token___x8kpoq punctuation___x8kpoq">"</span></span> <span class="token___x8kpoq punctuation___x8kpoq">/></span></span></li><li><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq tag___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">&#x3C;/</span>div</span><span class="token___x8kpoq punctuation___x8kpoq">></span></span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[css]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li><span class="token___x8kpoq selector___x8kpoq"><span class="token___x8kpoq class___x8kpoq">.demo-input</span></span><span class="token___x8kpoq punctuation___x8kpoq">{</span></li><li>    <span class="token___x8kpoq property___x8kpoq">margin</span><span class="token___x8kpoq punctuation___x8kpoq">:</span> <span class="token___x8kpoq number___x8kpoq">10</span>px<span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li>    <span class="token___x8kpoq property___x8kpoq">background-color</span><span class="token___x8kpoq punctuation___x8kpoq">:</span> gold<span class="token___x8kpoq punctuation___x8kpoq">;</span></li><li><span class="token___x8kpoq punctuation___x8kpoq">}</span></li><li></li><li>// [actions]、[mount]的代码同上节，省略不写<span class="token___x8kpoq number___x8kpoq">...</span></li><li></li></ol>'
                                            }
                                        },
                                        {
                                            s: "\r\n要点，就是不想要要点，就像html+css那样直白",
                                            k: 48
                                        },
                                        {
                                            t: "br",
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                href: "p102-demo-helloworld-p2d4.html",
                                                target: "_blank"
                                            }
                                        },
                                        {
                                        ...
                                        {
                                            s:
                                                "\r\n比如，常规的添加前缀、压缩去重复、url地址修改图片资源复制，等等，rpose会整合相关工具处理，打消顾虑",
                                            k: 61
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n这个rpose花了点力气，按组件单位，把样式类名哈希化，能确保无冲突",
                                            k: 66
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n        写个伪html，写个样式，加上事件写些脚本，最基础的东西其实都已经有了",
                                            k: 75
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n        想试试看？不急，再来几个组件熟悉一下，然后，确实有兴趣有共鸣，再随时开始不迟",
                                            k: 78
                                        },
                                        {
                                            t: "br",
                    ...
                    rpose.mount(rpose.newComponentProxy("p102-demo-helloworld").render(), "body");
                })(rpose.$$);
            },
            {
