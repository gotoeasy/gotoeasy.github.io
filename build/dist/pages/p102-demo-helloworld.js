...
(function($$, escapeHtml) {
    ...
    // 属性接口定义
    P102DemoHelloworld.prototype.$OPTION_KEYS = null; // 可通过标签配置的属性，未定义则不支持外部配置
    P102DemoHelloworld.prototype.$STATE_KEYS = null; // 可更新的state属性，未定义则不支持外部更新state

    // 组件函数
    function P102DemoHelloworld(options = {}) {
        // 组件默认选项值
        this.$options = {};
        ...
        return {
            ...
            c: [
                ...
                { t: "ui-sidemenu", m: 1, k: 3 },
                {
                    ...
                    a: { class: { _zfj478: 1 } },
                    c: [
                        { t: "ui-blockquote", a: { text: "2.1 第一个 hello world 组件" }, m: 1, k: 5 },
                        {
                            t: "```",
                            a: {
                                lang: "btf",
                                $code:
                                    '<ol><li><span class="hljs-comment">// 文件名 ui-helloworld.btf</span></li><li></li><li>[<span class="hljs-meta">api</span>]</li><li>statekeys = name   <span class="hljs-comment">// 意思是说，组件的状态不是外部所能随便改的，这里声明仅接受‘name’的修改</span></li><li></li><li>[<span class="hljs-meta">view</span>]</li><li>&lt;span&gt;hello {name}!&lt;/span&gt;</li><li></li><li>[<span class="hljs-meta">state</span>] <span class="hljs-comment">// 状态默认值，如果没有接收到name参数，显示的就是world了，避免空白难看</span></li><li>{</li><li>    name: <span class="hljs-string">\'world\'</span></li><li>}</li></ol>'
                            },
                            m: 1,
                            k: 6
                        },
                        { s: "\r\n这就是创建了一个组件了，功能上很简单，接受name参数然后拼接显示", k: 7 },
                        { t: "br", x: 1, k: 8 },
                        { s: "\r\n组件名根据文件名转换而来，即 UiHelloworld，也就是意味着文件名不能乱写特殊字符，这应该不算事", k: 9 },
                        { t: "br", x: 1, k: 10 },
                        { t: "ui-line", m: 1, k: 11 },
                        { t: "ui-blockquote", a: { text: "2.2 使用 hello world 组件" }, m: 1, k: 12 },
                        { s: "\r\n为了看到 hello world 的效果，简单写一个页面", k: 13 },
                        { t: "br", x: 1, k: 14 },
                        { s: "\r\n页面也是组件，不过是多了个挂载显示\r\n", k: 15 },
                        {
                            t: "```",
                            a: {
                                $code:
                                    '<ol><li><span class="hljs-comment">// 文件名 demo-2-2-helloworld.btf</span></li><li></li><li>[<span class="hljs-meta">view</span>]</li><li>&lt;ui-helloworld/&gt;</li><li></li><li>[<span class="hljs-meta">mount</span>] <span class="hljs-comment">// 挂载显示</span></li><li>body</li></ol>'
                            },
                            m: 1,
                            k: 16
                        },
                        { s: "这便是把 hello world 组件用起来了，效果用想，显示出“hello world!”而已，不信点 ", k: 17 },
                        { t: "a", a: { href: "demo-2-2-helloworld.html", target: "_blank" }, c: [{ s: "这里", k: 19 }], x: 1, k: 18 },
                        { t: "ui-line", m: 1, k: 20 },
                        { t: "ui-blockquote", a: { text: "2.3 修改 hello world 组件状态" }, m: 1, k: 21 },
                        { s: "\r\n要修改组件状态，3个要素，什么组件？什么时机？改成什么？", k: 22 },
                        { t: "br", x: 1, k: 23 },
                        { s: "\r\n下面代码演示，在输入框onchange时，拿到hello world组件对象，把它的name修改为输入框的值\r\n", k: 24 },
                        {
                            ...
                            a: {
                                $code:
                                    '<ol><li><span class="hljs-comment">// 文件名 demo-2-3-helloworld.btf</span></li><li></li><li>[<span class="hljs-meta">view</span>]</li><li>&lt;div&gt;</li><li>    &lt;input onchange=<span class="hljs-string">"fnChange"</span>&gt;</li><li>    &lt;ui-helloworld <span class="hljs-keyword">ref</span>=<span class="hljs-string">"hello"</span> name=<span class="hljs-string">"rpose"</span> /&gt;</li><li>&lt;/div&gt;</li><li></li><li>[<span class="hljs-meta">actions</span>]</li><li>{</li><li>    fnChange: e=&gt; {</li><li>        <span class="hljs-keyword">let</span> txt = e.target.<span class="hljs-keyword">value</span>;</li><li>        <span class="hljs-keyword">let</span> helloworld = <span class="hljs-keyword">this</span>.getRefComponent(<span class="hljs-string">\'hello\'</span>);</li><li>        helloworld.setState({name:txt});</li><li>    }</li><li>}</li><li></li><li>[<span class="hljs-meta">mount</span>] <span class="hljs-comment">// 挂载显示</span></li><li>body</li></ol>'
                            },
                            m: 1,
                            k: 25
                        },
                        { s: "\r\n要点1，事件的绑定，沿用html习惯直接写onchange的，处理函数是写在[actions]里的，通过名称关联起来的", k: 26 },
                        { t: "br", x: 1, k: 27 },
                        { s: "\r\n要点2，取组件对象，沿用习惯要设定ref属性，组件对象默认提供getRefComponent方法可用", k: 28 },
                        { t: "br", x: 1, k: 29 },
                        { s: "\r\n要点3，修改状态，沿用习惯通过组件的setState方法实现", k: 30 },
                        { t: "br", x: 1, k: 31 },
                        { t: "br", x: 1, k: 32 },
                        { s: "\r\n看效果点 ", k: 33 },
                        { t: "a", a: { href: "demo-2-3-helloworld.html", target: "_blank" }, c: [{ s: "这里", k: 35 }], x: 1, k: 34 },
                        { t: "br", x: 1, k: 36 },
                        { t: "br", x: 1, k: 37 },
                        { s: "\r\n扩充点1，组件根部是一个标签节点，多了不行。为什么要这样，习惯...其实主要是影响虚拟节点比较的算法实现", k: 38 },
                        { t: "br", x: 1, k: 39 },
                        { s: "\r\n扩充点2，还有getRefComponents方法，返回的是数组，还有getRefElements、getRefElement方法，对应返回真实Dom", k: 40 },
                        { t: "br", x: 1, k: 41 },
                        { s: "\r\n扩充点3，还有getState方法，返回组件状态的副本", k: 42 },
                        { t: "br", x: 1, k: 43 },
                        { t: "ui-line", m: 1, k: 44 },
                        { t: "ui-blockquote", a: { text: "2.4 使用样式" }, m: 1, k: 45 },
                        { s: "\r\n三驾马车HTML/JS/CSS就剩下CSS了", k: 46 },
                        { t: "br", x: 1, k: 47 },
                        { s: "\r\n没什么难的，rpose最讲究的是姿势，直接加就是\r\n", k: 48 },
                        {
                            ...
                            a: {
                                lang: "btf",
                                $code:
                                    '<ol><li><span class="hljs-comment">// 文件名 demo-2-4-helloworld.btf</span></li><li></li><li>[<span class="hljs-meta">view</span>]</li><li>&lt;div&gt;</li><li>    &lt;input <span class="hljs-keyword">class</span>=<span class="hljs-string">"demo-input"</span> onchange=<span class="hljs-string">"fnChange"</span>&gt;</li><li>    &lt;ui-helloworld <span class="hljs-keyword">ref</span>=<span class="hljs-string">"hello"</span> name=<span class="hljs-string">"rpose"</span> /&gt;</li><li>&lt;/div&gt;</li><li></li><li>[<span class="hljs-meta">css</span>]</li><li>.demo-input{</li><li>    margin: <span class="hljs-number">10</span>px;</li><li>    background-color: gold;</li><li>}</li><li></li><li><span class="hljs-comment">// [actions]、[mount]的代码同上节，省略不写...</span></li><li></li></ol>'
                            },
                            m: 1,
                            k: 49
                        },
                        { s: "\r\n要点，就是不想要要点，就像html+css那样直白", k: 50 },
                        { t: "br", x: 1, k: 51 },
                        { s: "\r\n当然，为了习惯，写[scss]、[less]都是可以的，尝试吧", k: 52 },
                        { t: "br", x: 1, k: 53 },
                        { t: "br", x: 1, k: 54 },
                        { s: "\r\n看效果点 ", k: 55 },
                        { t: "a", a: { href: "demo-2-4-helloworld.html", target: "_blank" }, c: [{ s: "这里", k: 57 }], x: 1, k: 56 },
                        { t: "br", x: 1, k: 58 },
                        { t: "br", x: 1, k: 59 },
                        { t: "br", x: 1, k: 60 },
                        { s: "\r\n有顾虑？确实，样式问题还是很多的", k: 61 },
                        { t: "br", x: 1, k: 62 },
                        { s: "\r\n比如，常规的添加前缀、压缩去重复、url地址修改图片资源复制，等等，rpose会整合相关工具处理，打消顾虑", k: 63 },
                        { t: "br", x: 1, k: 64 },
                        { t: "br", x: 1, k: 65 },
                        { s: "\r\n样式类名冲突？", k: 66 },
                        { t: "br", x: 1, k: 67 },
                        { s: "\r\n这个rpose花了点力气，按组件单位，把样式类名哈希化，能确保无冲突", k: 68 },
                        { t: "br", x: 1, k: 69 },
                        { s: "\r\n所以也是有推荐写法的，就是尽量使用类名，尽量不用标签名或id，避免rpose无法帮忙\r\n\r\n\r\n        ", k: 70 },
                        { t: "br", x: 1, k: 71 },
                        { t: "br", x: 1, k: 72 },
                        { t: "ui-line", m: 1, k: 73 },
                        { t: "ui-blockquote", a: { text: "2.5 小结" }, m: 1, k: 74 },
                        { s: "\r\n        通过本章节，对rpose的代码写法的掌握，可以说已达60%", k: 75 },
                        { t: "br", x: 1, k: 76 },
                        { s: "\r\n        写个伪html，写个样式，加上事件写些脚本，最基础的东西其实都已经有了", k: 77 },
                        { t: "br", x: 1, k: 78 },
                        { t: "br", x: 1, k: 79 },
                        { s: "\r\n        想试试看？不急，再来几个组件熟悉一下，然后，确实有兴趣有共鸣，再随时开始不迟", k: 80 },
                        { t: "br", x: 1, k: 81 },
                        { t: "ui-line", m: 1, k: 82 },
                        { t: "ui-button", a: { value: "1 初识 rpose", onclick: $actions.pre }, m: 1, k: 83 },
                        { t: "span", a: { style: "margin:0 80px 0 0" }, x: 1, k: 84 },
                        { t: "ui-button", a: { value: "3 再几个组件熟悉一下", onclick: $actions.next }, m: 1, k: 85 }
                    ],
                    x: 1,
                    k: 4
                },
