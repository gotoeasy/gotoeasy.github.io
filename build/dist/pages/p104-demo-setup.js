...
(function($$, escapeHtml) {
    ...
    // 属性接口定义
    P104DemoSetup.prototype.$OPTION_KEYS = null; // 可通过标签配置的属性，未定义则不支持外部配置
    P104DemoSetup.prototype.$STATE_KEYS = null; // 可更新的state属性，未定义则不支持外部更新state

    // 组件函数
    function P104DemoSetup(options = {}) {
        // 组件默认选项值
        this.$options = {};
        ...
        return {
            ...
            c: [
                ...
                { t: "ui-sidemenu", m: 1, k: 3 },
                {
                    ...
                    a: { class: { _19h559h: 1 } },
                    c: [
                        { t: "ui-blockquote", a: { text: "4.1 安装rpose命令行工具" }, m: 1, k: 5 },
                        { t: "```", a: { $code: '<ol><li><span class="hljs-built_in">npm</span> i -g @rpose/cli</li></ol>' }, m: 1, k: 6 },
                        { t: "ui-line", m: 1, k: 7 },
                        { t: "ui-blockquote", a: { text: "4.2 克隆本网页项目进行体验" }, m: 1, k: 8 },
                        { s: "\r\n本网页效果都看了，怎么写的，下载下来直观的试试看", k: 9 },
                        { t: "br", x: 1, k: 10 },
                        { s: "\r\n本地建个目录，克隆https://github.com/gotoeasy/gotoeasy.github.io.git", k: 11 },
                        { t: "br", x: 1, k: 12 },
                        { s: "\r\n假设克隆到目录 D:/test，应该有文件D:/test/rpose.config.btf，以及D:/test/src这样的目录", k: 13 },
                        { t: "br", x: 1, k: 14 },
                        { t: "br", x: 1, k: 15 },
                        { s: "\r\n命令行，准备开始\r\n", k: 16 },
                        {
                            ...
                            a: {
                                $code:
                                    '<ol><li><span class="hljs-string">//</span> 进入项目目录</li><li><span class="hljs-keyword">cd</span> D:<span class="hljs-string">/test</span></li><li></li><li><span class="hljs-string">//</span> 安装依赖包，就是那个rpose-theme-demo</li><li>npm i rpose-theme-demo</li><li></li><li><span class="hljs-string">//</span> 准备开始，初次启动，需要给点耐心，不出意外必定成功</li><li><span class="hljs-string">//</span> 用watch模式比较直观，加上-clean是先清除build目录，方便看新生成的东西</li><li>rpose watch -clean</li></ol>'
                            },
                            m: 1,
                            k: 17
                        },
                        { s: "目前，watch模式有已知bug，可能也有未知bug，看有没有空改进了", k: 18 },
                        { t: "br", x: 1, k: 19 },
                        { s: "\r\n成功后是打开了浏览器显示了首页，接下去就可以对照源码看看build目录中的东西了\r\n\r\n\r\n", k: 20 },
                        { t: "ui-line", m: 1, k: 21 },
                        { t: "ui-blockquote", a: { text: "4.3 其实应该先看配置" }, m: 1, k: 22 },
                        { s: "\r\n首先是项目根目录下的配置文件 rpose.config.btf，内容直白不用解释", k: 23 },
                        { t: "br", x: 1, k: 24 },
                        {
                            t: "```",
                            a: {
                                lang: "btf",
                                $code:
                                    '<ol><li><span class="hljs-comment">// 项目配置文件 rpose.config.btf</span></li><li></li><li>[path]</li><li><span class="hljs-string">src                 :</span> src</li><li><span class="hljs-string">src_btf             :</span> src/btf</li><li><span class="hljs-string">src_components      :</span> src<span class="hljs-regexp">/btf/</span>components</li><li><span class="hljs-string">src_pages           :</span> src<span class="hljs-regexp">/btf/</span>pages</li><li><span class="hljs-string">src_resources       :</span> src/resources</li><li></li><li><span class="hljs-string">build               :</span> build</li><li><span class="hljs-string">build_temp          :</span> build/temp</li><li><span class="hljs-string">build_dist          :</span> build/dist</li><li></li><li>[theme] <span class="hljs-comment">// 样式风格包</span></li><li>rpose-theme-demo</li></ol>'
                            },
                            m: 1,
                            k: 25
                        },
                        { t: "ui-line", m: 1, k: 26 },
                        { t: "ui-blockquote", a: { text: "4.4 另一个重要的配置文件" }, m: 1, k: 27 },
                        { s: "\r\n另一个重要的配置文件是根目录下的 .browserslistrc，配置目标浏览器", k: 28 },
                        { t: "br", x: 1, k: 29 },
                        {
                            t: "```",
                            a: {
                                $code:
                                    '<ol><li><span class="hljs-comment">// 目标浏览器配置文件 .browserslistrc</span></li><li></li><li># 在线查询 https:<span class="hljs-comment">//browserl.ist</span></li><li></li><li># 全球市场份额<span class="hljs-number">2</span>%以上</li><li>&gt;= <span class="hljs-number">2</span>%</li><li># 中国市场份额<span class="hljs-number">1</span>%以上</li><li>&gt;= <span class="hljs-number">1</span>% <span class="hljs-keyword">in</span> cn</li><li># 市场份额不足<span class="hljs-number">0.5</span>%或<span class="hljs-number">2</span>年内未升级的除外</li><li><span class="hljs-keyword">not</span> dead</li><li></li><li># 包含特定版本</li><li>ie <span class="hljs-number">11</span></li></ol>'
                            },
                            m: 1,
                            k: 30
                        },
                        ...
                        { t: "ui-line", m: 1, k: 32 },
                        { t: "ui-blockquote", a: { text: "4.5 我们要打包了" }, m: 1, k: 33 },
                        { s: "\r\n我们要的打包效果是，按页面单位有文件html、js、css各一个", k: 34 },
                        { t: "br", x: 1, k: 35 },
                        { s: "\r\n公共包抽取之类暂时不考虑，因为打包出来的文件实在是不够大\r\n", k: 36 },
                        {
                            t: "```",
                            a: { $code: '<ol><li><span class="hljs-symbol">rpose</span> <span class="hljs-keyword">build </span>-c -r</li></ol>' },
                            m: 1,
                            k: 37
                        },
                        { s: "\r\n这里并没有提到打包的什么配置", k: 38 },
                        { t: "br", x: 1, k: 39 },
                        { s: "\r\n因为，要打包，理论上给的需求已经充分，让它跑起来吧。鸣谢众多开源作者\r\n\r\n\r\n\r\n\r\n\r\n", k: 40 },
                        { t: "ui-line", m: 1, k: 41 },
                        { t: "ui-blockquote", a: { text: "4.6 小结" }, m: 1, k: 42 },
                        { s: "\r\n        效果摆在那里，小结则是多余，必须再次鸣谢众多开源项目及其作者", k: 43 },
                        { t: "br", x: 1, k: 44 },
                        { t: "br", x: 1, k: 45 },
                        { s: "\r\n        鸣谢node.js平台，确实方便了大家", k: 46 },
                        { t: "br", x: 1, k: 47 },
                        { s: "\r\n        鸣谢babel，7.x.x版本令人愉悦", k: 48 },
                        { t: "br", x: 1, k: 49 },
                        { s: "\r\n        鸣谢core-js，庞大的苦活，辛苦了", k: 50 },
                        { t: "br", x: 1, k: 51 },
                        { s: "\r\n        鸣谢browserify，干得漂亮", k: 52 },
                        { t: "br", x: 1, k: 53 },
                        { s: "\r\n        鸣谢postcss，做得不错", k: 54 },
                        { t: "br", x: 1, k: 55 },
                        { s: "\r\n        鸣谢browserslist，要的就是这效果", k: 56 },
                        { t: "br", x: 1, k: 57 },
                        { s: "\r\n        鸣谢acorn，这是真技术", k: 58 },
                        { t: "br", x: 1, k: 59 },
                        { s: "\r\n        鸣谢browser-sync，体贴到位", k: 60 },
                        { t: "br", x: 1, k: 61 },
                        { s: "\r\n        ...", k: 62 },
                        { t: "br", x: 1, k: 63 },
                        { s: "\r\n        ...", k: 64 },
                        ...
                        { s: "\r\n        ...", k: 66 },
                        { t: "br", x: 1, k: 67 },
                        { s: "\r\n        不罗列鸣谢过意不去，一旦罗列又必定有漏，虽有漏，内心是感激的，赞", k: 68 },
                        { t: "br", x: 1, k: 69 },
                        { t: "br", x: 1, k: 70 },
                        { t: "ui-line", m: 1, k: 71 },
                        { t: "ui-button", a: { value: "3 再几个组件熟悉一下", onclick: $actions.pre }, m: 1, k: 72 },
                        { t: "span", a: { style: "margin:0 80px 0 0" }, x: 1, k: 73 },
                        { t: "ui-button", a: { value: "5 下一个关心点（TODO）", onclick: $actions.next, disabled: 1 }, m: 1, k: 74 }
                    ],
                    x: 1,
                    k: 4
                },
                { t: "ui-line", m: 1, k: 75 },
                { t: "div", a: { style: "text-align:center;margin-bottom:20px" }, c: [{ s: "青松 2018.12", k: 77 }], x: 1, k: 76 }
            ],
            x: 1,
            k: 1
        };
