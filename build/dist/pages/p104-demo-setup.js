        ...
        1: [
            function(require, module, exports) {
                ...
                (function($$) {
                    ...
                    P104DemoSetup.prototype.$OPTION_KEYS = undefined; // 可通过标签配置的属性，未定义则不支持外部配置

                    P104DemoSetup.prototype.$STATE_KEYS = ["$SLOT"]; // 可更新的state属性，未定义则不支持外部更新state
                    // 组件函数

                    function P104DemoSetup() {
                        var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
                        // 组件默认选项值
                        this.$options = {}; // 组件默认数据状态值
                    ...
                    P104DemoSetup.prototype.nodeTemplate = function nodeTemplate($state, $options, $actions, $this) {
                        return {
                            t: "div",
                            r: 1,
                            k: 73,
                                ...
                                },
                                {
                                    ...
                                    c: [
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                $CODE:
                                                    '<ol><li>npm i <span class="token___x8kpoq operator___x8kpoq">-</span>g @rpose<span class="token___x8kpoq operator___x8kpoq">/</span>cli</li></ol>'
                                            }
                                        },
                                        {
                                            t: "ui-line",
                                        ...
                                        },
                                        {
                                            ...
                                            c: [],
                                            a: {
                                                text: "4.2 克隆本网页项目进行体验"
                                            }
                                        },
                                        {
                                            s: "\r\n本网页效果都看了，怎么写的，下载下来直观的试试看",
                                            k: 7
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n本地建个目录，克隆https://github.com/gotoeasy/gotoeasy.github.io.git",
                                            k: 9
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n假设克隆到目录 D:/test，应该有文件D:/test/rpose.config.btf，以及D:/test/src这样的目录",
                                            k: 11
                                        },
                                        {
                                            t: "br",
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq comment___x8kpoq">// 进入项目目录</span></li><li>cd D<span class="token___x8kpoq punctuation___x8kpoq">:</span><span class="token___x8kpoq operator___x8kpoq">/</span>test</li><li></li><li><span class="token___x8kpoq comment___x8kpoq">// 准备开始，初次启动，需要给点耐心，不出意外必定成功</span></li><li><span class="token___x8kpoq comment___x8kpoq">// 用watch模式比较直观，加上-clean是先清除build目录，方便看新生成的东西</span></li><li>rpose watch <span class="token___x8kpoq operator___x8kpoq">-</span>clean</li></ol>'
                                            }
                                        },
                                        {
                                            s: "成功后是打开了浏览器显示了首页，接下去就可以对照源码看看build目录中的东西了\r\n\r\n\r\n",
                                            k: 16
                                        },
                                        {
                                            t: "ui-line",
                                        ...
                                        {
                                            s: "\r\n项目根目录下的配置文件 rpose.config.btf，内容简单直白，但很关键",
                                            k: 19
                                        },
                                        {
                                            t: "br",
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                lang: "btf",
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq comment___x8kpoq">// 项目配置文件 rpose.config.btf</span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[path]</span><span class="token___x8kpoq selector___x8kpoq"></span></li><li><span class="token___x8kpoq constant___x8kpoq">build</span>               <span class="token___x8kpoq attr-value___x8kpoq"><span class="token___x8kpoq punctuation___x8kpoq">:</span> build</span></li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[theme]</span><span class="token___x8kpoq selector___x8kpoq"></span> <span class="token___x8kpoq comment___x8kpoq">// 样式风格包</span></li><li>rpose-theme-demo</li><li></li><li><span class="token___x8kpoq selector___x8kpoq">[prerender]</span><span class="token___x8kpoq selector___x8kpoq"></span> <span class="token___x8kpoq comment___x8kpoq">// 预渲染包</span></li><li>@gotoeasy/pre-render</li></ol>'
                                            }
                                        },
                                        {
                                            t: "ui-line",
                                        ...
                                        {
                                            s: "\r\n另一个重要的配置文件是根目录下的 .browserslistrc，配置目标浏览器",
                                            k: 24
                                        },
                                        {
                                            t: "br",
                                        ...
                                        },
                                        {
                                            ...
                                            a: {
                                                lang: "properties",
                                                $CODE:
                                                    '<ol><li><span class="token___x8kpoq attr-name___x8kpoq">//</span> <span class="token___x8kpoq attr-value___x8kpoq">目标浏览器配置文件 .browserslistrc</span></li><li></li><li><span class="token___x8kpoq comment___x8kpoq"># 在线查询 https://browserl.ist</span></li><li></li><li><span class="token___x8kpoq comment___x8kpoq"># 全球市场份额2%以上</span></li><li><span class="token___x8kpoq attr-name___x8kpoq">></span><span class="token___x8kpoq punctuation___x8kpoq">=</span> <span class="token___x8kpoq attr-value___x8kpoq">2%</span></li><li><span class="token___x8kpoq comment___x8kpoq"># 中国市场份额1%以上</span></li><li><span class="token___x8kpoq attr-name___x8kpoq">></span><span class="token___x8kpoq punctuation___x8kpoq">=</span> <span class="token___x8kpoq attr-value___x8kpoq">1% in cn</span></li><li><span class="token___x8kpoq comment___x8kpoq"># 市场份额不足0.5%或2年内未升级的除外</span></li><li><span class="token___x8kpoq attr-name___x8kpoq">not</span> <span class="token___x8kpoq attr-value___x8kpoq">dead</span></li><li></li><li><span class="token___x8kpoq comment___x8kpoq"># 包含特定版本</span></li><li><span class="token___x8kpoq attr-name___x8kpoq">ie</span> <span class="token___x8kpoq attr-value___x8kpoq">11</span></li></ol>'
                                            }
                                        },
                                        {
                                            s: "\r\n根据需要而改吧，只要你愿意你可以改到ie8，累的是机器，付出的是众多开源作者\r\n\r\n\r\n\r\n",
                                            k: 27
                                        },
                                        {
                                            t: "ui-line",
                                        ...
                                        {
                                            s: "\r\n我们要的打包效果是，按页面单位有文件html、js、css各一个",
                                            k: 30
                                        },
                                        {
                                            t: "br",
                                        ...
                                        {
                                            s: "\r\n公共包抽取之类暂时不考虑，因为目前打包出来的文件实在是太小还不值得分\r\n",
                                            k: 32
                                        },
                                        {
                                            t: "@rpose/buildin:```",
                                            ...
                                            a: {
                                                $CODE:
                                                    '<ol><li>rpose build <span class="token___x8kpoq operator___x8kpoq">-</span>c <span class="token___x8kpoq operator___x8kpoq">-</span>r</li></ol>'
                                            }
                                        },
                                        {
                                            s: "\r\n这里并没有提到打包的什么配置",
                                        ...
                                        {
                                            s: "\r\n        不罗列鸣谢过意不去，一旦罗列又必定有漏，虽有漏，内心是感激的，赞",
                                            k: 62
                                        },
                                        {
                                            t: "br",
                    ...
                    rpose.mount(rpose.newComponentProxy("p104-demo-setup").render(), "body");
                })(rpose.$$);
            },
            {
