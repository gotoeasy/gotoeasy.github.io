            ...
            function(require, module, exports) {
                ...
                (function($$) {
                    ...
                    rpose.registerComponents({
                        ...
                        "p106-demo-slot-p6d3": P106DemoSlotP6d3
                    }); // ------------------------------------------------------------------------------------------------------
                    // 组件 DemoLayout
                    ...
                    DemoLayout.prototype.$OPTION_KEYS = undefined; // 可通过标签配置的属性，未定义则不支持外部配置

                    DemoLayout.prototype.$STATE_KEYS = ["$SLOT"]; // 可更新的state属性，未定义则不支持外部更新state
                    // 组件函数
                    ...
                    DemoLayout.prototype.nodeTemplate = function nodeTemplate($state, $options, $actions, $this) {
                        var v_Array = [];
                        ...
                        ($state.$SLOT || []).forEach(function(vn) {
                            if (vn.a) {
                                ...
                                vn.a.slot === "menu" && (slotVnodes_1lv8rye = vn.c || []);
                                vn.a.slot === "page" && (slotVnodes_1lvl2rq = vn.c || []);
                            }
                        });
                        v_Array.push({
                            t: "div",
                                    ...
                                    c: [
                                        {
                                            ...
                                            k: 2,
                                            c: (function(_Ary) {
                                                _Ary.push.apply(_Ary, _toConsumableArray(slotVnodes_1lv8rye));

                                                return _Ary;
                                            })([]),
                                            a: {
                                                class: {
                                                    "layout-menu___9cp8e9": 1
                                                }
                                            }
                                        },
                                        {
                                        ...
                                        },
                                        {
                                            ...
                                            k: 4,
                                            c: (function(_Ary) {
                                                _Ary.push.apply(_Ary, _toConsumableArray(slotVnodes_1lvl2rq));

                                                return _Ary;
                                            })([]),
                                            a: {
                                                class: {
                                                    "layout-page___9cp8e9": 1
                                                }
                                            }
                                        }
                                    ],
                    ...
                    P106DemoSlotP6d3.prototype.$OPTION_KEYS = undefined; // 可通过标签配置的属性，未定义则不支持外部配置

                    P106DemoSlotP6d3.prototype.$STATE_KEYS = ["$SLOT"]; // 可更新的state属性，未定义则不支持外部更新state
                    // 组件函数

                    function P106DemoSlotP6d3() {
                        var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
                        // 组件默认选项值
                        this.$options = {}; // 组件默认数据状态值
                    ...
                    P106DemoSlotP6d3.prototype.nodeTemplate = function nodeTemplate($state, $options, $actions, $this) {
                        return {
                            t: "demo-layout",
                            r: 1,
                            m: 1,
                    ...
                    rpose.mount(rpose.newComponentProxy("p106-demo-slot-p6d3").render(), "body");
                })(rpose.$$);
            },
            {
