        ...
        1: [
            function(require, module, exports) {
                ...
                (function($$) {
                    ...
                    TodoList.prototype.$OPTION_KEYS = undefined; // 可通过标签配置的属性，未定义则不支持外部配置

                    TodoList.prototype.$STATE_KEYS = ["$SLOT"]; // 可更新的state属性，未定义则不支持外部更新state
                    // 组件函数
                    ...
                    function TodoList() {
                        ...
                        this.$actions = {
                            add: function add(e) {
                                ...
                                var el = _this2.getRefElement("input");

                                el.value && _this2.$state.items.push(el.value) && (el.value = "");
                            ...
                            del: function del(e) {
                                ...
                                _this2.$state.items.splice(index, 1);
                    ...
                    TodoList.prototype.nodeTemplate = function nodeTemplate($state, $options, $actions, $this) {
                        return {
                            t: "div",
                            r: 1,
                            k: 12,
                            c: [
                                ...
                                },
                                {
                                    ...
                                    k: 7,
                                    c: (function(_Ary) {
                                        for (var i = 0, ARY_ = $state.items, MAX_ = ARY_.length, item; i < MAX_; i++) {
                                            item = ARY_[i];
                    ...
                    rpose.mount(rpose.newComponentProxy("todo-list").render(), "body");
                })(rpose.$$);
            },
            {
