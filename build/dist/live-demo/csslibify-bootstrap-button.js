            ...
            function(require, module, exports) {
                ...
                (function($$) {
                    ...
                    rpose.registerComponents({
                        "csslibify-bootstrap-button": CsslibifyBootstrapButton
                    }); // ------------------------------------------------------------------------------------------------------
                    // 组件 CsslibifyBootstrapButton
                    // 注:应通过rpose.newComponentProxy方法创建组件代理对象后使用，而不是直接调用方法或用new创建
                    // ------------------------------------------------------------------------------------------------------
                    // 属性接口定义

                    CsslibifyBootstrapButton.prototype.$OPTION_KEYS = undefined; // 可通过标签配置的属性，未定义则不支持外部配置

                    CsslibifyBootstrapButton.prototype.$STATE_KEYS = ["$SLOT"]; // 可更新的state属性，未定义则不支持外部更新state
                    // 组件函数

                    function CsslibifyBootstrapButton() {
                    ...
                    CsslibifyBootstrapButton.prototype.nodeTemplate = function nodeTemplate($state, $options, $actions, $this) {
                        return {
                            t: "button",
                            r: 1,
                            k: 2,
                            ...
                            a: {
                                ...
                                class: {
                                    "bootstrap---btn": 1,
                                    "bootstrap---btn-primary": 1
                                }
                            }
                        };
                    }; // 组件挂载

                    rpose.mount(rpose.newComponentProxy("csslibify-bootstrap-button").render(), "body");
                })(rpose.$$);
            },
            {
